...
Please change the parent <Route path="${e}"> to <Route path="${e===`/`?`*`:`${e}/*`}">.`)}let u=ht(),d;if(t){let e=typeof t==`string`?ue(t):t;w(c===`/`||e.pathname?.startsWith(c),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${c}" but pathname "${e.pathname}" was given in the \`location\` prop.`),d=e}else d=u;let f=d.pathname||`/`,p=f;if(c!==`/`){let e=c.replace(/^\//,``).split(`/`);p=`/`+f.replace(/^\//,``).split(`/`).slice(e.length).join(`/`)}let m=n&&n.state.matches.length?n.state.matches.map(e=>Object.assign(e,{route:n.manifest[e.route.id]||e.route})):de(e,{pathname:p});ae(l||m!=null,`No routes matched location "${d.pathname}${d.search}${d.hash}" `),ae(m==null||m[m.length-1].route.element!==void 0||m[m.length-1].route.Component!==void 0||m[m.length-1].route.lazy!==void 0,`Matched leaf route at location "${d.pathname}${d.search}${d.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let h=At(m&&m.map(e=>Object.assign({},e,{params:Object.assign({},o,e.params),pathname:Le([c,r.encodeLocation?r.encodeLocation(e.pathname.replace(/%/g,`%25`).replace(/\?/g,`%3F`).replace(/#/g,`%23`)).pathname:e.pathname]),pathnameBase:e.pathnameBase===`/`?c:Le([c,r.encodeLocation?r.encodeLocation(e.pathnameBase.replace(/%/g,`%25`).replace(/\?/g,`%3F`).replace(/#/g,`%23`)).pathname:e.pathnameBase])})),i,n);return t&&h?_.createElement(at.Provider,{value:{location:{pathname:`/`,search:``,hash:``,state:null,key:`default`,mask:void 0,...d},navigationType:`POP`}},h):h}function wt(){let e=Lt(),t=Ue(e)?`${e.status} ${e.statusText}`:e instanceof Error?e.message:JSON.stringify(e),n=e instanceof Error?e.stack:null,r=`rgba(200,200,200, 0.5)`,i={padding:`0.5rem`,backgroundColor:r},a={padding:`2px 4px`,backgroundColor:r},o=null;return console.error(`Error handled by React Router default ErrorBoundary:`,e),o=_.createElement(_.Fragment,null,_.createElement(`p`,null,`💿 Hey developer 👋`),_.createElement(`p`,null,`You can provide a way better UX than this when your app throws errors by providing your own `,_.createElement(`code`,{style:a},`ErrorBoundary`),` or`,` `,_.createElement(`code`,{style:a},`errorElement`),` prop on your route.`)),_.createElement(_.Fragment,null,_.createElement(`h2`,null,`Unexpected Application Error!`),_.createElement(`h3`,{style:{fontStyle:`italic`}},t),n?_.createElement(`pre`,{style:i},n):null,o)}var Tt=_.createElement(wt,null),Et=class extends _.Component{constructor(e){super(e),this.state={location:e.location,revalidation:e.revalidation,error:e.error}}static getDerivedStateFromError(e){return{error:e}}static getDerivedStateFromProps(e,t){return t.location!==e.location||t.revalidation!==`idle`&&e.revalidation===`idle`?{error:e.error,location:e.location,revalidation:e.revalidation}:{error:e.error===void 0?t.error:e.error,location:t.location,revalidation:e.revalidation||t.revalidation}}componentDidCatch(e,t){this.props.onError?this.props.onError(e,t):console.error(`React Router caught the following error during render`,e)}render(){let e=this.state.error;if(this.context&&typeof e==`object`&&e&&`digest`in e&&typeof e.digest==`string`){let t=ft(e.digest);t&&(e=t)}let t=e===void 0?this.props.children:_.createElement(ot.Provider,{value:this.props.routeContext},_.createElement(st.Provider,{value:e,children:this.props.component}));return this.context?_.createElement(Ot,{error:e},t):t}};Et.contextType=$e;var Dt=new WeakMap;function Ot({children:e,error:t}){let{basename:n}=_.useContext(it);if(typeof t==`object`&&t&&`digest`in t&&typeof t.digest==`string`){let e=dt(t.digest);if(e){let r=Dt.get(t);if(r)throw r;let i=Ke(e.location,n),a=i.absoluteURL||i.to;if(Xe(a))throw Error(`Invalid redirect location`);if(Ge&&!Dt.get(t)){if(i.isExternal||e.reloadDocument)window.location.href=a;else{let n=Promise.resolve().then(()=>window.__reactRouterDataRouter.navigate(i.to,{replace:e.replace}));throw Dt.set(t,n),n}}return _.createElement(`meta`,{httpEquiv:`refresh`,content:`0;url=${a}`})}}return e}function kt({routeContext:e,match:t,children:n}){let r=_.useContext(Ze);return r&&r.static&&r.staticContext&&(t.route.errorElement||t.route.ErrorBoundary)&&(r.staticContext._deepestRenderedBoundaryId=t.route.id),_.createElement(ot.Provider,{value:e},n)}function At(e,t=[],n){let r=n?.state;if(e==null){if(!r)return null;if(r.errors)e=r.matches;else if(t.length===0&&!r.initialized&&r.matches.length>0)e=r.matches;else return null}let i=e,a=r?.errors;if(a!=null){let e=i.findIndex(e=>e.route.id&&a?.[e.route.id]!==void 0);w(e>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(a).join(`,`)}`),i=i.slice(0,Math.min(i.length,e+1))}let o=!1,s=-1;if(n&&r){o=r.renderFallback;for(let e=0;e<i.length;e++){let t=i[e];if((t.route.HydrateFallback||t.route.hydrateFallbackElement)&&(s=e),t.route.id){let{loaderData:e,errors:a}=r,c=t.route.loader&&!e.hasOwnProperty(t.route.id)&&(!a||a[t.route.id]===void 0);if(t.route.lazy||c){n.isStatic&&(o=!0),i=s>=0?i.slice(0,s+1):[i[0]];break}}}}let c=n?.onError,l=r&&c?(e,t)=>{c(e,{location:r.location,params:r.matches?.[0]?.params??{},pattern:We(r.matches),errorInfo:t})}:void 0;return i.reduceRight((e,n,c)=>{let u,d=!1,f=null,p=null;r&&(u=a&&n.route.id?a[n.route.id]:void 0,f=n.route.errorElement||Tt,o&&(s<0&&c===0?(Bt(`route-fallback`,!1,"No `HydrateFallback` element provided to render during initial hydration"),d=!0,p=null):s===c&&(d=!0,p=n.route.hydrateFallbackElement||null)));let m=t.concat(i.slice(0,c+1)),h=()=>{let t;return t=u?f:d?p:n.route.Component?_.createElement(n.route.Component,null):n.route.element?n.route.element:e,_.createElement(kt,{match:n,routeContext:{outlet:e,matches:m,isDataRoute:r!=null},children:t})};return r&&(n.route.ErrorBoundary||n.route.errorElement||c===0)?_.createElement(Et,{location:r.location,revalidation:r.revalidation,component:f,error:u,children:h(),routeContext:{outlet:null,matches:m,isDataRoute:!0},onError:l}):h()},null)}function jt(e){return`${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Mt(e){let t=_.useContext(Ze);return w(t,jt(e)),t}function Nt(e){let t=_.useContext(Qe);return w(t,jt(e)),t}function Pt(e){let t=_.useContext(ot);return w(t,jt(e)),t}function Ft(e){let t=Pt(e),n=t.matches[t.matches.length-1];return w(n.route.id,`${e} can only be used on routes that contain a unique "id"`),n.route.id}function It(){return Ft(`useRouteId`)}function Lt(){let e=_.useContext(st),t=Nt(`useRouteError`),n=Ft(`useRouteError`);return e===void 0?t.errors?.[n]:e}function Rt(){let{router:e}=Mt(`useNavigate`),t=Ft(`useNavigate`),n=_.useRef(!1);return _t(()=>{n.current=!0}),_.useCallback(async(r,i={})=>{ae(n.current,gt),n.current&&(typeof r==`number`?await e.navigate(r):await e.navigate(r,{fromRouteId:t,...i}))},[e,t])}var zt={};function Bt(e,t,n){!t&&!zt[e]&&(zt[e]=!0,ae(!1,n))}_.memo(Vt);function Vt({routes:e,manifest:t,future:n,state:r,isStatic:i,onError:a}){return Ct(e,void 0,{manifest:t,state:r,isStatic:i,onError:a,future:n})}function Ht({to:e,replace:t,state:n,relative:r}){w(mt(),`<Navigate> may be used only in the context of a <Router> component.`);let{static:i}=_.useContext(it);ae(!i,`<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.`);let{matches:a}=_.useContext(ot),{pathname:o}=ht(),s=vt(),c=Fe(e,Pe(a),o,r===`path`),l=JSON.stringify(c);return _.useEffect(()=>{s(JSON.parse(l),{replace:t,state:n,relative:r})},[s,l,r,t,n]),null}function Ut(e){w(!1,`A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.`)}function Wt({basename:e=`/`,children:t=null,location:n,navigationType:r=`POP`,navigator:i,static:a=!1,useTransitions:o}){w(!mt(),`You cannot render a <Router> inside another <Router>. You should never have more than one in your app.`);let s=e.replace(/^\/*/,`/`),c=_.useMemo(()=>({basename:s,navigator:i,static:a,useTransitions:o,future:{}}),[s,i,a,o]);typeof n==`string`&&(n=ue(n));let{pathname:l=`/`,search:u=``,hash:d=``,state:f=null,key:p=`default`,mask:m}=n,h=_.useMemo(()=>{let e=ke(l,s);return e==null?null:{location:{pathname:e,search:u,hash:d,state:f,key:p,mask:m},navigationType:r}},[s,l,u,d,f,p,r,m]);return ae(h!=null,`<Router basename="${s}"> is not able to match the URL "${l}${u}${d}" because it does not start with the basename, so the <Router> won't render anything.`),h==null?null:_.createElement(it.Provider,{value:c},_.createElement(at.Provider,{children:t,value:h}))}function Gt({children:e,location:t}){return St(Kt(e),t)}_.Component;function Kt(e,t=[]){let n=[];return _.Children.forEach(e,(e,r)=>{if(!_.isValidElement(e))return;let i=[...t,r];if(e.type===_.Fragment){n.push.apply(n,Kt(e.props.children,i));return}w(e.type===Ut,`[${typeof e.type==`string`?e.type:e.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),w(!e.props.index||!e.props.children,`An index route cannot have child routes.`);let a={id:e.props.id||i.join(`-`),caseSensitive:e.props.caseSensitive,element:e.props.element,Component:e.props.Component,index:e.props.index,path:e.props.path,middleware:e.props.middleware,loader:e.props.loader,action:e.props.action,hydrateFallbackElement:e.props.hydrateFallbackElement,HydrateFallback:e.props.HydrateFallback,errorElement:e.props.errorElement,ErrorBoundary:e.props.ErrorBoundary,hasErrorBoundary:e.props.hasErrorBoundary===!0||e.props.ErrorBoundary!=null||e.props.errorElement!=null,shouldRevalidate:e.props.shouldRevalidate,handle:e.props.handle,lazy:e.props.lazy};e.props.children&&(a.children=Kt(e.props.children,i)),n.push(a)}),n}var qt=`get`,Jt=`application/x-www-form-urlencoded`;function Yt(e){return typeof HTMLElement<`u`&&e instanceof HTMLElement}function Xt(e){return Yt(e)&&e.tagName.toLowerCase()===`button`}function Zt(e){return Yt(e)&&e.tagName.toLowerCase()===`form`}function Qt(e){return Yt(e)&&e.tagName.toLowerCase()===`input`}function $t(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}function en(e,t){return e.button===0&&(!t||t===`_self`)&&!$t(e)}var tn=null;function nn(){if(tn===null)try{new FormData(document.createElement(`form`),0),tn=!1}catch{tn=!0}return tn}var rn=new Set([`application/x-www-form-urlencoded`,`multipart/form-data`,`text/plain`]);function an(e){return e!=null&&!rn.has(e)?(ae(!1,`"${e}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Jt}"`),null):e}function on(e,t){let n,r,i,a,o;if(Zt(e)){let o=e.getAttribute(`action`);r=o?ke(o,t):null,n=e.getAttribute(`method`)||qt,i=an(e.getAttribute(`enctype`))||Jt,a=new FormData(e)}else if(Xt(e)||Qt(e)&&(e.type===`submit`||e.type===`image`)){let o=e.form;if(o==null)throw Error(`Cannot submit a <button> or <input type="submit"> without a <form>`);let s=e.getAttribute(`formaction`)||o.getAttribute(`action`);if(r=s?ke(s,t):null,n=e.getAttribute(`formmethod`)||o.getAttribute(`method`)||qt,i=an(e.getAttribute(`formenctype`))||an(o.getAttribute(`enctype`))||Jt,a=new FormData(o,e),!nn()){let{name:t,type:n,value:r}=e;if(n===`image`){let e=t?`${t}.`:``;a.append(`${e}x`,`0`),a.append(`${e}y`,`0`)}else t&&a.append(t,r)}}else if(Yt(e))throw Error(`Cannot submit element that is not <form>, <button>, or <input type="submit|image">`);else n=qt,r=null,i=Jt,o=e;return a&&i===`text/plain`&&(o=a,a=void 0),{action:r,method:n.toLowerCase(),encType:i,formData:a,body:o}}Object.getOwnPropertyNames(Object.prototype).sort().join(`\0`);function sn(e,t){if(e===!1||e==null)throw Error(t)}function cn(e,t,n,r){let i=typeof e==`string`?new URL(e,typeof window>`u`?`server://singlefetch/`:window.location.origin):e;return i.pathname=n?i.pathname.endsWith(`/`)?`${i.pathname}_.${r}`:`${i.pathname}.${r}`:i.pathname===`/`?`_root.${r}`:t&&ke(i.pathname,t)===`/`?`${Re(t)}/_root.${r}`:`${Re(i.pathname)}.${r}`,i}async function ln(e,t){if(e.id in t)return t[e.id];try{let n=await ee(()=>import(e.module),[]);return t[e.id]=n,n}catch(t){return console.error(`Error loading route module \`${e.module}\`, reloading page...`),console.error(t),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function un(e){return e!=null&&typeof e.page==`string`}function dn(e){return e==null?!1:e.href==null?e.rel===`preload`&&typeof e.imageSrcSet==`string`&&typeof e.imageSizes==`string`:typeof e.rel==`string`&&typeof e.href==`string`}async function fn(e,t,n){return _n((await Promise.all(e.map(async e=>{let r=t.routes[e.route.id];if(r){let e=await ln(r,n);return e.links?e.links():[]}return[]}))).flat(1).filter(dn).filter(e=>e.rel===`stylesheet`||e.rel===`preload`).map(e=>e.rel===`stylesheet`?{...e,rel:`prefetch`,as:`style`}:{...e,rel:`prefetch`}))}function pn(e,t,n,r,i,a){let o=(e,t)=>!n[t]||e.route.id!==n[t].route.id,s=(e,t)=>n[t].pathname!==e.pathname||n[t].route.path?.endsWith(`*`)&&n[t].params[`*`]!==e.params[`*`];return a===`assets`?t.filter((e,t)=>o(e,t)||s(e,t)):a===`data`?t.filter((t,a)=>{let c=r.routes[t.route.id];if(!c||!c.hasLoader)return!1;if(o(t,a)||s(t,a))return!0;if(t.route.shouldRevalidate){let r=t.route.shouldRevalidate({currentUrl:new URL(i.pathname+i.search+i.hash,window.origin),currentParams:n[0]?.params||{},nextUrl:new URL(e,window.origin),nextParams:t.params,defaultShouldRevalidate:!0});if(typeof r==`boolean`)return r}return!0}):[]}function mn(e,t,{includeHydrateFallback:n}={}){return hn(e.map(e=>{let r=t.routes[e.route.id];if(!r)return[];let i=[r.module];return r.clientActionModule&&(i=i.concat(r.clientActionModule)),r.clientLoaderModule&&(i=i.concat(r.clientLoaderModule)),n&&r.hydrateFallbackModule&&(i=i.concat(r.hydrateFallbackModule)),r.imports&&(i=i.concat(r.imports)),i}).flat(1))}function hn(e){return[...new Set(e)]}function gn(e){let t={},n=Object.keys(e).sort();for(let r of n)t[r]=e[r];return t}function _n(e,t){let n=new Set,r=new Set(t);return e.reduce((e,i)=>{if(t&&!un(i)&&i.as===`script`&&i.href&&r.has(i.href))return e;let a=JSON.stringify(gn(i));return n.has(a)||(n.add(a),e.push({key:a,link:i})),e},[])}function vn(){let e=_.useContext(Ze);return sn(e,`You must render this element inside a <DataRouterContext.Provider> element`),e}function yn(){let e=_.useContext(Qe);return sn(e,`You must render this element inside a <DataRouterStateContext.Provider> element`),e}var bn=_.createContext(void 0);bn.displayName=`FrameworkContext`;function xn(){let e=_.useContext(bn);return sn(e,`You must render this element inside a <HydratedRouter> element`),e}function Sn(e,t){let n=_.useContext(bn),[r,i]=_.useState(!1),[a,o]=_.useState(!1),{onFocus:s,onBlur:c,onMouseEnter:l,onMouseLeave:u,onTouchStart:d}=t,f=_.useRef(null);_.useEffect(()=>{if(e===`render`&&o(!0),e===`viewport`){let e=new IntersectionObserver(e=>{e.forEach(e=>{o(e.isIntersecting)})},{threshold:.5});return f.current&&e.observe(f.current),()=>{e.disconnect()}}},[e]),_.useEffect(()=>{if(r){let e=setTimeout(()=>{o(!0)},100);return()=>{clearTimeout(e)}}},[r]);let p=()=>{i(!0)},m=()=>{i(!1),o(!1)};return n?e===`intent`?[a,f,{onFocus:Cn(s,p),onBlur:Cn(c,m),onMouseEnter:Cn(l,p),onMouseLeave:Cn(u,m),onTouchStart:Cn(d,p)}]:[a,f,{}]:[!1,f,{}]}function Cn(e,t){return n=>{e&&e(n),n.defaultPrevented||t(n)}}function wn({page:e,...t}){let n=et(),{nonce:r}=xn(),{router:i}=vn(),a=_.useMemo(()=>de(i.routes,e,i.basename),[i.routes,e,i.basename]);return a?(t.nonce==null&&r&&(t={...t,nonce:r}),n?_.createElement(En,{page:e,matches:a,...t}):_.createElement(Dn,{page:e,matches:a,...t})):null}function Tn(e){let{manifest:t,routeModules:n}=xn(),[r,i]=_.useState([]);return _.useEffect(()=>{let r=!1;return fn(e,t,n).then(e=>{r||i(e)}),()=>{r=!0}},[e,t,n]),r}function En({page:e,matches:t,...n}){let r=ht(),{future:i}=xn(),{basename:a}=vn(),o=_.useMemo(()=>{if(e===r.pathname+r.search+r.hash)return[];let n=cn(e,a,i.v8_trailingSlashAwareDataRequests,`rsc`),o=!1,s=[];for(let e of t)typeof e.route.shouldRevalidate==`function`?o=!0:s.push(e.route.id);return o&&s.length>0&&n.searchParams.set(`_routes`,s.join(`,`)),[n.pathname+n.search]},[a,i.v8_trailingSlashAwareDataRequests,e,r,t]);return _.createElement(_.Fragment,null,o.map(e=>_.createElement(`link`,{key:e,rel:`prefetch`,as:`fetch`,href:e,...n})))}function Dn({page:e,matches:t,...n}){let r=ht(),{future:i,manifest:a,routeModules:o}=xn(),{basename:s}=vn(),{loaderData:c,matches:l}=yn(),u=_.useMemo(()=>pn(e,t,l,a,r,`data`),[e,t,l,a,r]),d=_.useMemo(()=>pn(e,t,l,a,r,`assets`),[e,t,l,a,r]),f=_.useMemo(()=>{if(e===r.pathname+r.search+r.hash)return[];let n=new Set,l=!1;if(t.forEach(e=>{let t=a.routes[e.route.id];!t||!t.hasLoader||(!u.some(t=>t.route.id===e.route.id)&&e.route.id in c&&o[e.route.id]?.shouldRevalidate||t.hasClientLoader?l=!0:n.add(e.route.id))}),n.size===0)return[];let d=cn(e,s,i.v8_trailingSlashAwareDataRequests,`data`);return l&&n.size>0&&d.searchParams.set(`_routes`,t.filter(e=>n.has(e.route.id)).map(e=>e.route.id).join(`,`)),[d.pathname+d.search]},[s,i.v8_trailingSlashAwareDataRequests,c,r,a,u,t,e,o]),p=_.useMemo(()=>mn(d,a),[d,a]),m=Tn(d);return _.createElement(_.Fragment,null,f.map(e=>_.createElement(`link`,{key:e,rel:`prefetch`,as:`fetch`,href:e,...n})),p.map(e=>_.createElement(`link`,{key:e,rel:`modulepreload`,href:e,...n})),m.map(({key:e,link:t})=>_.createElement(`link`,{key:e,nonce:n.nonce,...t,crossOrigin:t.crossOrigin??n.crossOrigin})))}function On(...e){return t=>{e.forEach(e=>{typeof e==`function`?e(t):e!=null&&(e.current=t)})}}_.Component;var kn=typeof window<`u`&&window.document!==void 0&&window.document.createElement!==void 0;try{kn&&(window.__reactRouterVersion=`7.18.2`)}catch{}function An({basename:e,children:t,useTransitions:n,window:r}){let i=_.useRef();i.current??=ie({window:r,v5Compat:!0});let a=i.current,[o,s]=_.useState({action:a.action,location:a.location}),c=_.useCallback(e=>{n===!1?s(e):_.startTransition(()=>s(e))},[n]);return _.useLayoutEffect(()=>a.listen(c),[a,c]),_.createElement(Wt,{basename:e,children:t,location:o.location,navigationType:o.action,navigator:a,useTransitions:n})}var k=_.forwardRef(function({onClick:e,discover:t=`render`,prefetch:n=`none`,relative:r,reloadDocument:i,replace:a,mask:o,state:s,target:c,to:l,preventScrollReset:u,viewTransition:d,defaultShouldRevalidate:f,...p},m){let{basename:h,navigator:g,useTransitions:v}=_.useContext(it),y=typeof l==`string`&&S.test(l),b=Ke(l,h);l=b.to;let x=pt(l,{relative:r}),ee=ht(),C=null;if(o){let e=Fe(o,[],ee.mask?ee.mask.pathname:`/`,!0);h!==`/`&&(e.pathname=e.pathname===`/`?h:Le([h,e.pathname])),C=g.createHref(e)}let[te,ne,re]=Sn(n,p),ie=Fn(l,{replace:a,mask:o,state:s,target:c,preventScrollReset:u,relative:r,viewTransition:d,defaultShouldRevalidate:f,useTransitions:v});function w(t){e&&e(t),t.defaultPrevented||ie(t)}let ae=!(b.isExternal||i),oe=_.createElement(`a`,{...p,...re,href:(ae?C:void 0)||b.absoluteURL||x,onClick:ae?w:e,ref:On(m,ne),target:c,"data-discover":!y&&t===`render`?`true`:void 0});return te&&!y?_.createElement(_.Fragment,null,oe,_.createElement(wn,{page:x})):oe});k.displayName=`Link`;var jn=_.forwardRef(function({"aria-current":e=`page`,caseSensitive:t=!1,className:n=``,end:r=!1,style:i,to:a,viewTransition:o,children:s,...c},l){let u=xt(a,{relative:c.relative}),d=ht(),f=_.useContext(Qe),{navigator:p,basename:m}=_.useContext(it),h=f!=null&&Bn(u)&&o===!0,g=p.encodeLocation?p.encodeLocation(u).pathname:u.pathname,v=d.pathname,y=f&&f.navigation&&f.navigation.location?f.navigation.location.pathname:null;t||(v=v.toLowerCase(),y=y?y.toLowerCase():null,g=g.toLowerCase()),y&&m&&(y=ke(y,m)||y);let b=g!==`/`&&g.endsWith(`/`)?g.length-1:g.length,x=v===g||!r&&v.startsWith(g)&&v.charAt(b)===`/`,ee=y!=null&&(y===g||!r&&y.startsWith(g)&&y.charAt(g.length)===`/`),S={isActive:x,isPending:ee,isTransitioning:h},C=x?e:void 0,te;te=typeof n==`function`?n(S):[n,x?`active`:null,ee?`pending`:null,h?`transitioning`:null].filter(Boolean).join(` `);let ne=typeof i==`function`?i(S):i;return _.createElement(k,{...c,"aria-current":C,className:te,ref:l,style:ne,to:a,viewTransition:o},typeof s==`function`?s(S):s)});jn.displayName=`NavLink`;var Mn=_.forwardRef(({discover:e=`render`,fetcherKey:t,navigate:n,reloadDocument:r,replace:i,state:a,method:o=qt,action:s,onSubmit:c,relative:l,preventScrollReset:u,viewTransition:d,defaultShouldRevalidate:f,...p},m)=>{let{useTransitions:h}=_.useContext(it),g=Rn(),v=zn(s,{relative:l}),y=o.toLowerCase()===`get`?`get`:`post`,b=typeof s==`string`&&S.test(s);return _.createElement(`form`,{ref:m,method:y,action:v,onSubmit:r?c:e=>{if(c&&c(e),e.defaultPrevented)return;e.preventDefault();let r=e.nativeEvent.submitter,s=r?.getAttribute(`formmethod`)||o,p=()=>g(r||e.currentTarget,{fetcherKey:t,method:s,navigate:n,replace:i,state:a,relative:l,preventScrollReset:u,viewTransition:d,defaultShouldRevalidate:f});h&&n!==!1?_.startTransition(()=>p()):p()},...p,"data-discover":!b&&e===`render`?`true`:void 0})});Mn.displayName=`Form`;function Nn(e){return`${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Pn(e){let t=_.useContext(Ze);return w(t,Nn(e)),t}function Fn(e,{target:t,replace:n,mask:r,state:i,preventScrollReset:a,relative:o,viewTransition:s,defaultShouldRevalidate:c,useTransitions:l}={}){let u=vt(),d=ht(),f=xt(e,{relative:o});return _.useCallback(p=>{if(en(p,t)){p.preventDefault();let t=n===void 0?le(d)===le(f):n,m=()=>u(e,{replace:t,mask:r,state:i,preventScrollReset:a,relative:o,viewTransition:s,defaultShouldRevalidate:c});l?_.startTransition(()=>m()):m()}},[d,u,f,n,r,i,t,e,a,o,s,c,l])}var In=0,Ln=()=>`__${String(++In)}__`;function Rn(){let{router:e}=Pn(`useSubmit`),{basename:t}=_.useContext(it),n=It(),r=e.fetch,i=e.navigate;return _.useCallback(async(e,a={})=>{let{action:o,method:s,encType:c,formData:l,body:u}=on(e,t);if(a.navigate===!1){let e=a.fetcherKey||Ln();await r(e,n,a.action||o,{defaultShouldRevalidate:a.defaultShouldRevalidate,preventScrollReset:a.preventScrollReset,formData:l,body:u,formMethod:a.method||s,formEncType:a.encType||c,flushSync:a.flushSync})}else await i(a.action||o,{defaultShouldRevalidate:a.defaultShouldRevalidate,preventScrollReset:a.preventScrollReset,formData:l,body:u,formMethod:a.method||s,formEncType:a.encType||c,replace:a.replace,state:a.state,fromRouteId:n,flushSync:a.flushSync,viewTransition:a.viewTransition})},[r,i,t,n])}function zn(e,{relative:t}={}){let{basename:n}=_.useContext(it),r=_.useContext(ot);w(r,`useFormAction must be used inside a RouteContext`);let[i]=r.matches.slice(-1),a={...xt(e||`.`,{relative:t})},o=ht();if(e==null){a.search=o.search;let e=new URLSearchParams(a.search),t=e.getAll(`index`);if(t.some(e=>e===``)){e.delete(`index`),t.filter(e=>e).forEach(t=>e.append(`index`,t));let n=e.toString();a.search=n?`?${n}`:``}}return(!e||e===`.`)&&i.route.index&&(a.search=a.search?a.search.replace(/^\?/,`?index&`):`?index`),n!==`/`&&(a.pathname=a.pathname===`/`?n:Le([n,a.pathname])),le(a)}function Bn(e,{relative:t}={}){let n=_.useContext(tt);w(n!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:r}=Pn(`useViewTransitionState`),i=xt(e,{relative:t});if(!n.isTransitioning)return!1;let a=ke(n.currentLocation.pathname,r)||n.currentLocation.pathname,o=ke(n.nextLocation.pathname,r)||n.nextLocation.pathname;return Te(i.pathname,o)!=null||Te(i.pathname,a)!=null}var Vn=o(((e,t)=>{var n=typeof Element<`u`,r=typeof Map==`function`,i=typeof Set==`function`,a=typeof ArrayBuffer==`function`&&!!ArrayBuffer.isView;function o(e,t){if(e===t)return!0;if(e&&t&&typeof e==`object`&&typeof t==`object`){if(e.constructor!==t.constructor)return!1;var s,c,l;if(Array.isArray(e)){if(s=e.length,s!=t.length)return!1;for(c=s;c--!==0;)if(!o(e[c],t[c]))return!1;return!0}var u;if(r&&e instanceof Map&&t instanceof Map){if(e.size!==t.size)return!1;for(u=e.entries();!(c=u.next()).done;)if(!t.has(c.value[0]))return!1;for(u=e.entries();!(c=u.next()).done;)if(!o(c.value[1],t.get(c.value[0])))return!1;return!0}if(i&&e instanceof Set&&t instanceof Set){if(e.size!==t.size)return!1;for(u=e.entries();!(c=u.next()).done;)if(!t.has(c.value[0]))return!1;return!0}if(a&&ArrayBuffer.isView(e)&&ArrayBuffer.isView(t)){if(s=e.length,s!=t.length)return!1;for(c=s;c--!==0;)if(e[c]!==t[c])return!1;return!0}if(e.constructor===RegExp)return e.source===t.source&&e.flags===t.flags;if(e.valueOf!==Object.prototype.valueOf&&typeof e.valueOf==`function`&&typeof t.valueOf==`function`)return e.valueOf()===t.valueOf();if(e.toString!==Object.prototype.toString&&typeof e.toString==`function`&&typeof t.toString==`function`)return e.toString()===t.toString();if(l=Object.keys(e),s=l.length,s!==Object.keys(t).length)return!1;for(c=s;c--!==0;)if(!Object.prototype.hasOwnProperty.call(t,l[c]))return!1;if(n&&e instanceof Element)return!1;for(c=s;c--!==0;)if(!((l[c]===`_owner`||l[c]===`__v`||l[c]===`__o`)&&e.$$typeof)&&!o(e[l[c]],t[l[c]]))return!1;return!0}return e!==e&&t!==t}t.exports=function(e,t){try{return o(e,t)}catch(e){if((e.message||``).match(/stack|recursion/i))return console.warn(`react-fast-compare cannot handle circular refs`),!1;throw e}}})),Hn=o(((e,t)=>{t.exports=function(e,t,n,r,i,a,o,s){if(!e){var c;if(t===void 0)c=Error(`Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.`);else{var l=[n,r,i,a,o,s],u=0;c=Error(t.replace(/%s/g,function(){return l[u++]})),c.name=`Invariant Violation`}throw c.framesToPop=1,c}}})),Un=o(((e,t)=>{t.exports=function(e,t,n,r){var i=n?n.call(r,e,t):void 0;if(i!==void 0)return!!i;if(e===t)return!0;if(typeof e!=`object`||!e||typeof t!=`object`||!t)return!1;var a=Object.keys(e),o=Object.keys(t);if(a.length!==o.length)return!1;for(var s=Object.prototype.hasOwnProperty.bind(t),c=0;c<a.length;c++){var l=a[c];if(!s(l))return!1;var u=e[l],d=t[l];if(i=n?n.call(r,u,d,l):void 0,i===!1||i===void 0&&u!==d)return!1}return!0}})),Wn=c(Vn()),Gn=c(Hn()),Kn=c(Un()),qn=(e=>(e.BASE=`base`,e.BODY=`body`,e.HEAD=`head`,e.HTML=`html`,e.LINK=`link`,e.META=`meta`,e.NOSCRIPT=`noscript`,e.SCRIPT=`script`,e.STYLE=`style`,e.TITLE=`title`,e.FRAGMENT=`Symbol(react.fragment)`,e))(qn||{}),Jn={link:{rel:[`amphtml`,`canonical`,`alternate`]},script:{type:[`application/ld+json`]},meta:{charset:``,name:[`generator`,`robots`,`description`],property:[`og:type`,`og:title`,`og:url`,`og:image`,`og:image:alt`,`og:description`,`twitter:url`,`twitter:title`,`twitter:description`,`twitter:image`,`twitter:image:alt`,`twitter:card`,`twitter:site`]}},Yn=Object.values(qn),Xn={accesskey:`accessKey`,charset:`charSet`,class:`className`,contenteditable:`contentEditable`,contextmenu:`contextMenu`,"http-equiv":`httpEquiv`,itemprop:`itemProp`,tabindex:`tabIndex`},Zn=Object.entries(Xn).reduce((e,[t,n])=>(e[n]=t,e),{}),Qn=`data-rh`,$n={DEFAULT_TITLE:`defaultTitle`,DEFER:`defer`,ENCODE_SPECIAL_CHARACTERS:`encodeSpecialCharacters`,ON_CHANGE_CLIENT_STATE:`onChangeClientState`,TITLE_TEMPLATE:`titleTemplate`,PRIORITIZE_SEO_TAGS:`prioritizeSeoTags`},er=(e,t)=>{for(let n=e.length-1;n>=0;--n){let r=e[n];if(Object.prototype.hasOwnProperty.call(r,t))return r[t]}return null},tr=e=>{let t=er(e,`title`),n=er(e,$n.TITLE_TEMPLATE);if(Array.isArray(t)&&(t=t.join(``)),n&&t)return n.replace(/%s/g,()=>t);let r=er(e,$n.DEFAULT_TITLE);return t||r||void 0},nr=e=>er(e,$n.ON_CHANGE_CLIENT_STATE)||(()=>{}),rr=(e,t)=>t.filter(t=>t[e]!==void 0).map(t=>t[e]).reduce((e,t)=>({...e,...t}),{}),ir=(e,t)=>t.filter(e=>e.base!==void 0).map(e=>e.base).reverse().reduce((t,n)=>{if(!t.length){let r=Object.keys(n);for(let i=0;i<r.length;i+=1){let a=r[i].toLowerCase();if(e.indexOf(a)!==-1&&n[a])return t.concat(n)}}return t},[]),ar=e=>console&&typeof console.warn==`function`&&console.warn(e),or=(e,t,n)=>{let r={};return n.filter(t=>Array.isArray(t[e])?!0:(t[e]!==void 0&&ar(`Helmet: ${e} should be of type "Array". Instead found type "${typeof t[e]}"`),!1)).map(t=>t[e]).reverse().reduce((e,n)=>{let i={};n.filter(e=>{let n,a=Object.keys(e);for(let r=0;r<a.length;r+=1){let i=a[r],o=i.toLowerCase();t.indexOf(o)!==-1&&(n!==`rel`||e[n].toLowerCase()!==`canonical`)&&(o!==`rel`||e[o].toLowerCase()!==`stylesheet`)&&(n=o),t.indexOf(i)!==-1&&(i===`innerHTML`||i===`cssText`||i===`itemprop`)&&(n=i)}if(!n||!e[n])return!1;let o=e[n].toLowerCase();return r[n]||(r[n]={}),i[n]||(i[n]={}),!r[n][o]&&(i[n][o]=!0,!0)}).reverse().forEach(t=>e.push(t));let a=Object.keys(i);for(let e=0;e<a.length;e+=1){let t=a[e],n={...r[t],...i[t]};r[t]=n}return e},[]).reverse()},sr=(e,t)=>{if(Array.isArray(e)&&e.length){for(let n=0;n<e.length;n+=1)if(e[n][t])return!0}return!1},cr=e=>({baseTag:ir([`href`],e),bodyAttributes:rr(`bodyAttributes`,e),defer:er(e,$n.DEFER),encode:er(e,$n.ENCODE_SPECIAL_CHARACTERS),htmlAttributes:rr(`htmlAttributes`,e),linkTags:or(`link`,[`rel`,`href`],e),metaTags:or(`meta`,[`name`,`charset`,`http-equiv`,`property`,`itemprop`],e),noscriptTags:or(`noscript`,[`innerHTML`],e),onChangeClientState:nr(e),scriptTags:or(`script`,[`src`,`innerHTML`],e),styleTags:or(`style`,[`cssText`],e),title:tr(e),titleAttributes:rr(`titleAttributes`,e),prioritizeSeoTags:sr(e,$n.PRIORITIZE_SEO_TAGS)}),lr=e=>Array.isArray(e)?e.join(``):e,ur=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r+=1)if(t[n[r]]&&t[n[r]].includes(e[n[r]]))return!0;return!1},dr=(e,t)=>Array.isArray(e)?e.reduce((e,n)=>(ur(n,t)?e.priority.push(n):e.default.push(n),e),{priority:[],default:[]}):{default:e,priority:[]},fr=(e,t)=>({...e,[t]:void 0}),pr=[`noscript`,`script`,`style`],mr=(e,t=!0)=>t===!1?String(e):String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#x27;`),hr=e=>Object.keys(e).reduce((t,n)=>{let r=e[n]===void 0?`${n}`:`${n}="${e[n]}"`;return t?`${t} ${r}`:r},``),gr=(e,t,n,r)=>{let i=hr(n),a=lr(t);return i?`<${e} ${Qn}="true" ${i}>${mr(a,r)}</${e}>`:`<${e} ${Qn}="true">${mr(a,r)}</${e}>`},_r=(e,t,n=!0)=>t.reduce((t,r)=>{let i=r,a=Object.keys(i).filter(e=>e!==`innerHTML`&&e!==`cssText`).reduce((e,t)=>{let r=i[t]===void 0?t:`${t}="${mr(i[t],n)}"`;return e?`${e} ${r}`:r},``),o=i.innerHTML||i.cssText||``;return`${t}<${e} ${Qn}="true" ${a}${pr.indexOf(e)===-1?`/>`:`>${o}</${e}>`}`},``),vr=(e,t={})=>Object.keys(e).reduce((t,n)=>{let r=Xn[n];return t[r||n]=e[n],t},t),yr=(e,t,n)=>{let r=vr(n,{key:t,[Qn]:!0});return[_.createElement(`title`,r,t)]},br=(e,t)=>t.map((t,n)=>{let r={key:n,[Qn]:!0};return Object.keys(t).forEach(e=>{let n=Xn[e]||e;if(n===`innerHTML`||n===`cssText`){let e=t.innerHTML||t.cssText;r.dangerouslySetInnerHTML={__html:e}}else r[n]=t[e]}),_.createElement(e,r)}),xr=(e,t,n=!0)=>{switch(e){case`title`:return{toComponent:()=>yr(e,t.title,t.titleAttributes),toString:()=>gr(e,t.title,t.titleAttributes,n)};case`bodyAttributes`:case`htmlAttributes`:return{toComponent:()=>vr(t),toString:()=>hr(t)};default:return{toComponent:()=>br(e,t),toString:()=>_r(e,t,n)}}},Sr=({metaTags:e,linkTags:t,scriptTags:n,encode:r})=>{let i=dr(e,Jn.meta),a=dr(t,Jn.link),o=dr(n,Jn.script);return{priorityMethods:{toComponent:()=>[...br(`meta`,i.priority),...br(`link`,a.priority),...br(`script`,o.priority)],toString:()=>`${xr(`meta`,i.priority,r)} ${xr(`link`,a.priority,r)} ${xr(`script`,o.priority,r)}`},metaTags:i.default,linkTags:a.default,scriptTags:o.default}},Cr=e=>{let{baseTag:t,bodyAttributes:n,encode:r=!0,htmlAttributes:i,noscriptTags:a,styleTags:o,title:s=``,titleAttributes:c,prioritizeSeoTags:l}=e,{linkTags:u,metaTags:d,scriptTags:f}=e,p={toComponent:()=>[],toString:()=>``};return l&&({priorityMethods:p,linkTags:u,metaTags:d,scriptTags:f}=Sr(e)),{priority:p,base:xr(`base`,t,r),bodyAttributes:xr(`bodyAttributes`,n,r),htmlAttributes:xr(`htmlAttributes`,i,r),link:xr(`link`,u,r),meta:xr(`meta`,d,r),noscript:xr(`noscript`,a,r),script:xr(`script`,f,r),style:xr(`style`,o,r),title:xr(`title`,{title:s,titleAttributes:c},r)}},wr=[],Tr=!!(typeof window<`u`&&window.document&&window.document.createElement),Er=class{instances=[];canUseDOM=Tr;context;value={setHelmet:e=>{this.context.helmet=e},helmetInstances:{get:()=>this.canUseDOM?wr:this.instances,add:e=>{(this.canUseDOM?wr:this.instances).push(e)},remove:e=>{let t=(this.canUseDOM?wr:this.instances).indexOf(e);(this.canUseDOM?wr:this.instances).splice(t,1)}}};constructor(e,t){this.context=e,this.canUseDOM=t||!1,t||(e.helmet=Cr({baseTag:[],bodyAttributes:{},encodeSpecialCharacters:!0,htmlAttributes:{},linkTags:[],metaTags:[],noscriptTags:[],scriptTags:[],styleTags:[],title:``,titleAttributes:{}}))}},Dr=parseInt(`19.2.8`.split(`.`)[0],10)>=19,Or=_.createContext({}),kr=class e extends _.Component{static canUseDOM=Tr;helmetData;constructor(t){super(t),this.helmetData=Dr?null:new Er(this.props.context||{},e.canUseDOM)}render(){return Dr?_.createElement(_.Fragment,null,this.props.children):_.createElement(Or.Provider,{value:this.helmetData.value},this.props.children)}},Ar=(e,t)=>{let n=document.head||document.querySelector(`head`),r=n.querySelectorAll(`${e}[${Qn}]`),i=[].slice.call(r),a=[],o;return t&&t.length&&t.forEach(t=>{let n=document.createElement(e);for(let e in t)if(Object.prototype.hasOwnProperty.call(t,e)){if(e===`innerHTML`)n.innerHTML=t.innerHTML;else if(e===`cssText`){let e=t.cssText;n.appendChild(document.createTextNode(e))}else{let r=e,i=t[r]===void 0?``:t[r];n.setAttribute(e,i)}}n.setAttribute(Qn,`true`),i.some((e,t)=>(o=t,n.isEqualNode(e)))?i.splice(o,1):a.push(n)}),i.forEach(e=>e.parentNode?.removeChild(e)),a.forEach(e=>n.appendChild(e)),{oldTags:i,newTags:a}},jr=(e,t)=>{let n=document.getElementsByTagName(e)[0];if(!n)return;let r=n.getAttribute(Qn),i=r?r.split(`,`):[],a=[...i],o=Object.keys(t);for(let e of o){let r=t[e]||``;n.getAttribute(e)!==r&&n.setAttribute(e,r),i.indexOf(e)===-1&&i.push(e);let o=a.indexOf(e);o!==-1&&a.splice(o,1)}for(let e=a.length-1;e>=0;--e)n.removeAttribute(a[e]);i.length===a.length?n.removeAttribute(Qn):n.getAttribute(Qn)!==o.join(`,`)&&n.setAttribute(Qn,o.join(`,`))},Mr=(e,t)=>{e!==void 0&&document.title!==e&&(document.title=lr(e)),jr(`title`,t)},Nr=(e,t)=>{let{baseTag:n,bodyAttributes:r,htmlAttributes:i,linkTags:a,metaTags:o,noscriptTags:s,onChangeClientState:c,scriptTags:l,styleTags:u,title:d,titleAttributes:f}=e;jr(`body`,r),jr(`html`,i),Mr(d,f);let p={baseTag:Ar(`base`,n),linkTags:Ar(`link`,a),metaTags:Ar(`meta`,o),noscriptTags:Ar(`noscript`,s),scriptTags:Ar(`script`,l),styleTags:Ar(`style`,u)},m={},h={};Object.keys(p).forEach(e=>{let{newTags:t,oldTags:n}=p[e];t.length&&(m[e]=t),n.length&&(h[e]=p[e].oldTags)}),t&&t(),c(e,m,h)},Pr=null,Fr=e=>{Pr&&cancelAnimationFrame(Pr),e.defer?Pr=requestAnimationFrame(()=>{Nr(e,()=>{Pr=null})}):(Nr(e),Pr=null)},Ir=class extends _.Component{rendered=!1;shouldComponentUpdate(e){return!(0,Kn.default)(e,this.props)}componentDidUpdate(){this.emitChange()}componentWillUnmount(){let{helmetInstances:e}=this.props.context;e.remove(this),this.emitChange()}emitChange(){let{helmetInstances:e,setHelmet:t}=this.props.context,n=null,r=cr(e.get().map(e=>{let{context:t,...n}=e.props;return n}));kr.canUseDOM?Fr(r):Cr&&(n=Cr(r)),t(n)}init(){if(this.rendered)return;this.rendered=!0;let{helmetInstances:e}=this.props.context;e.add(this),this.emitChange()}render(){return this.init(),null}},Lr=[],Rr=e=>{let t={};for(let n of Object.keys(e))t[Zn[n]||n]=e[n];return t},zr=e=>{let t={};for(let n of Object.keys(e)){let r=Xn[n];t[r||n]=e[n]}return t},Br=(e,t)=>{if(!Tr)return;let n=document.getElementsByTagName(e)[0];if(!n)return;let r=`data-rh-managed`,i=n.getAttribute(r),a=i?i.split(`,`):[],o=Object.keys(t);for(let e of a)o.includes(e)||n.removeAttribute(e);for(let e of o){let r=t[e];r==null||r===!1?n.removeAttribute(e):r===!0?n.setAttribute(e,``):n.setAttribute(e,String(r))}o.length>0?n.setAttribute(r,o.join(`,`)):n.removeAttribute(r)},Vr=()=>{let e={},t={};for(let n of Lr){let{htmlAttributes:r,bodyAttributes:i}=n.props;r&&Object.assign(e,Rr(r)),i&&Object.assign(t,Rr(i))}Br(`html`,e),Br(`body`,t)},Hr=class extends _.Component{componentDidMount(){Lr.push(this),Vr()}componentDidUpdate(){Vr()}componentWillUnmount(){let e=Lr.indexOf(this);e!==-1&&Lr.splice(e,1),Vr()}resolveTitle(){let{title:e,titleTemplate:t,defaultTitle:n}=this.props;return e&&t?t.replace(/%s/g,()=>Array.isArray(e)?e.join(``):e):e||n||void 0}renderTitle(){let e=this.resolveTitle();if(e===void 0)return null;let t=this.props.titleAttributes||{};return _.createElement(`title`,zr(t),e)}renderBase(){let{base:e}=this.props;return e?_.createElement(`base`,zr(e)):null}renderMeta(){let{meta:e}=this.props;return!e||!Array.isArray(e)?null:e.map((e,t)=>_.createElement(`meta`,{key:t,...zr(e)}))}renderLink(){let{link:e}=this.props;return!e||!Array.isArray(e)?null:e.map((e,t)=>_.createElement(`link`,{key:t,...zr(e)}))}renderScript(){let{script:e}=this.props;return!e||!Array.isArray(e)?null:e.map((e,t)=>{let{innerHTML:n,...r}=e,i=zr(r);return n&&(i.dangerouslySetInnerHTML={__html:n}),_.createElement(`script`,{key:t,...i})})}renderStyle(){let{style:e}=this.props;return!e||!Array.isArray(e)?null:e.map((e,t)=>{let{cssText:n,...r}=e,i=zr(r);return n&&(i.dangerouslySetInnerHTML={__html:n}),_.createElement(`style`,{key:t,...i})})}renderNoscript(){let{noscript:e}=this.props;return!e||!Array.isArray(e)?null:e.map((e,t)=>{let{innerHTML:n,...r}=e,i=zr(r);return n&&(i.dangerouslySetInnerHTML={__html:n}),_.createElement(`noscript`,{key:t,...i})})}render(){return _.createElement(_.Fragment,null,this.renderTitle(),this.renderBase(),this.renderMeta(),this.renderLink(),this.renderScript(),this.renderStyle(),this.renderNoscript())}},Ur=class extends _.Component{static defaultProps={defer:!0,encodeSpecialCharacters:!0,prioritizeSeoTags:!1};shouldComponentUpdate(e){return!(0,Wn.default)(fr(this.props,`helmetData`),fr(e,`helmetData`))}mapNestedChildrenToProps(e,t){if(!t)return null;switch(e.type){case`script`:case`noscript`:return{innerHTML:t};case`style`:return{cssText:t};default:throw Error(`<${e.type} /> elements are self-closing and can not contain children. Refer to our API for more information.`)}}flattenArrayTypeChildren(e,t,n,r){return{...t,[e.type]:[...t[e.type]||[],{...n,...this.mapNestedChildrenToProps(e,r)}]}}mapObjectTypeChildren(e,t,n,r){switch(e.type){case`title`:return{...t,[e.type]:r,titleAttributes:{...n}};case`body`:return{...t,bodyAttributes:{...n}};case`html`:return{...t,htmlAttributes:{...n}};default:return{...t,[e.type]:{...n}}}}mapArrayTypeChildrenToProps(e,t){let n={...t};return Object.keys(e).forEach(t=>{n={...n,[t]:e[t]}}),n}warnOnInvalidChildren(e,t){return(0,Gn.default)(Yn.some(t=>e.type===t),typeof e.type==`function`?`You may be attempting to nest <Helmet> components within each other, which is not allowed. Refer to our API for more information.`:`Only elements types ${Yn.join(`, `)} are allowed. Helmet does not support rendering <${e.type}> elements. Refer to our API for more information.`),(0,Gn.default)(!t||typeof t==`string`||Array.isArray(t)&&!t.some(e=>typeof e!=`string`),`Helmet expects a string as a child of <${e.type}>. Did you forget to wrap your children in braces? ( <${e.type}>{\`\`}</${e.type}> ) Refer to our API for more information.`),!0}mapChildrenToProps(e,t){let n={};return _.Children.forEach(e,e=>{if(!e||!e.props)return;let{children:r,...i}=e.props,a=Object.keys(i).reduce((e,t)=>(e[Zn[t]||t]=i[t],e),{}),{type:o}=e;switch(typeof o==`symbol`?o=o.toString():this.warnOnInvalidChildren(e,r),o){case`Symbol(react.fragment)`:t=this.mapChildrenToProps(r,t);break;case`link`:case`meta`:case`noscript`:case`script`:case`style`:n=this.flattenArrayTypeChildren(e,n,a,r);break;default:t=this.mapObjectTypeChildren(e,t,a,r)}}),this.mapArrayTypeChildrenToProps(n,t)}render(){let{children:e,...t}=this.props,n={...t},{helmetData:r}=t;return e&&(n=this.mapChildrenToProps(e,n)),r&&!(r instanceof Er)&&(r=new Er(r.context,!0),delete n.helmetData),Dr?_.createElement(Hr,{...n}):r?_.createElement(Ir,{...n,context:r.value}):_.createElement(Or.Consumer,null,e=>_.createElement(Ir,{...n,context:e}))}},Wr=(...e)=>e.filter((e,t,n)=>!!e&&e.trim()!==``&&n.indexOf(e)===t).join(` `).trim(),Gr=e=>e.replace(/([a-z0-9])([A-Z])/g,`$1-$2`).toLowerCase(),Kr=e=>e.replace(/^([A-Z])|[\s-_]+(\w)/g,(e,t,n)=>n?n.toUpperCase():t.toLowerCase()),qr=e=>{let t=Kr(e);return t.charAt(0).toUpperCase()+t.slice(1)},Jr={xmlns:`http://www.w3.org/2000/svg`,width:24,height:24,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:2,strokeLinecap:`round`,strokeLinejoin:`round`},Yr=e=>{for(let t in e)if(t.startsWith(`aria-`)||t===`role`||t===`title`)return!0;return!1},Xr=(0,_.createContext)({}),Zr=()=>(0,_.useContext)(Xr),Qr=(0,_.forwardRef)(({color:e,size:t,strokeWidth:n,absoluteStrokeWidth:r,className:i=``,children:a,iconNode:o,...s},c)=>{let{size:l=24,strokeWidth:u=2,absoluteStrokeWidth:d=!1,color:f=`currentColor`,className:p=``}=Zr()??{},m=r??d?Number(n??u)*24/Number(t??l):n??u;return(0,_.createElement)(`svg`,{ref:c,...Jr,width:t??l??Jr.width,height:t??l??Jr.height,stroke:e??f,strokeWidth:m,className:Wr(`lucide`,p,i),...!a&&!Yr(s)&&{"aria-hidden":`true`},...s},[...o.map(([e,t])=>(0,_.createElement)(e,t)),...Array.isArray(a)?a:[a]])}),A=(e,t)=>{let n=(0,_.forwardRef)(({className:n,...r},i)=>(0,_.createElement)(Qr,{ref:i,iconNode:t,className:Wr(`lucide-${Gr(qr(e))}`,`lucide-${e}`,n),...r}));return n.displayName=qr(e),n},$r=A(`arrow-left`,[[`path`,{d:`m12 19-7-7 7-7`,key:`1l729n`}],[`path`,{d:`M19 12H5`,key:`x3x0zl`}]]),ei=A(`arrow-right`,[[`path`,{d:`M5 12h14`,key:`1ays0h`}],[`path`,{d:`m12 5 7 7-7 7`,key:`xquz4c`}]]),ti=A(`bell`,[[`path`,{d:`M10.268 21a2 2 0 0 0 3.464 0`,key:`vwvbt9`}],[`path`,{d:`M3.262 15.326A1 1 0 0 0 4 17h16a1 1 0 0 0 .74-1.673C19.41 13.956 18 12.499 18 8A6 6 0 0 0 6 8c0 4.499-1.411 5.956-2.738 7.326`,key:`11g9vi`}]]),ni=A(`book-open`,[[`path`,{d:`M12 5v16`,key:`1f6ucr`}],[`path`,{d:`M20.001 19A2 2 0 0022 17V5a2 2 0 00-1.999-2L16 3.002A5 5 0 0012 5a5 5 0 00-4-2H4a2 2 0 00-2 2v12a2 2 0 001.999 2H8a5 5 0 014 2 5 5 0 014-2z`,key:`1fyvmf`}]]),ri=A(`briefcase`,[[`path`,{d:`M16 20V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16`,key:`jecpp`}],[`rect`,{width:`20`,height:`14`,x:`2`,y:`6`,rx:`2`,key:`i6l2r4`}]]),ii=A(`calendar`,[[`path`,{d:`M8 2v3`,key:`1ioesn`}],[`path`,{d:`M16 2v3`,key:`otl347`}],[`rect`,{x:`3`,y:`3`,width:`18`,height:`18`,rx:`2`,key:`h1oib`}],[`path`,{d:`M3 9h18`,key:`1pudct`}]]),ai=A(`circle-check-big`,[[`path`,{d:`M21.801 10A10 10 0 1 1 17 3.335`,key:`yps3ct`}],[`path`,{d:`m9 11 3 3L22 4`,key:`1pflzl`}]]),oi=A(`clipboard-check`,[[`rect`,{width:`8`,height:`4`,x:`8`,y:`2`,rx:`1`,ry:`1`,key:`tgr4d6`}],[`path`,{d:`M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2`,key:`116196`}],[`path`,{d:`m9 14 2 2 4-4`,key:`df797q`}]]),si=A(`clock`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`path`,{d:`M12 6v6l4 2`,key:`mmk7yg`}]]),ci=A(`external-link`,[[`path`,{d:`M15 3h6v6`,key:`1q9fwt`}],[`path`,{d:`M10 14 21 3`,key:`gplh6r`}],[`path`,{d:`M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6`,key:`a6xqqp`}]]),li=A(`graduation-cap`,[[`path`,{d:`M21.42 10.922a1 1 0 0 0-.019-1.838L12.83 5.18a2 2 0 0 0-1.66 0L2.6 9.08a1 1 0 0 0 0 1.832l8.57 3.908a2 2 0 0 0 1.66 0z`,key:`j76jl0`}],[`path`,{d:`M22 10v6`,key:`1lu8f3`}],[`path`,{d:`M6 12.5V16a6 3 0 0 0 12 0v-3.5`,key:`1r8lef`}]]),ui=A(`layers`,[[`path`,{d:`M12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83z`,key:`zw3jo`}],[`path`,{d:`M2 12a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 12`,key:`1wduqc`}],[`path`,{d:`M2 17a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 17`,key:`kqbvx6`}]]),di=A(`leaf`,[[`path`,{d:`M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10Z`,key:`nnexq3`}],[`path`,{d:`M2 21c0-3 1.85-5.36 5.08-6C9.5 14.52 12 13 13 12`,key:`mt58a7`}]]),fi=A(`mail`,[[`path`,{d:`m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7`,key:`132q7q`}],[`rect`,{x:`2`,y:`4`,width:`20`,height:`16`,rx:`2`,key:`izxlao`}]]),pi=A(`map-pin`,[[`path`,{d:`M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0`,key:`1r0f0z`}],[`circle`,{cx:`12`,cy:`10`,r:`3`,key:`ilqhr7`}]]),mi=A(`menu`,[[`path`,{d:`M4 5h16`,key:`1tepv9`}],[`path`,{d:`M4 12h16`,key:`1lakjw`}],[`path`,{d:`M4 19h16`,key:`1djgab`}]]),hi=A(`message-circle`,[[`path`,{d:`M2.992 16.342a2 2 0 0 1 .094 1.167l-1.065 3.29a1 1 0 0 0 1.236 1.168l3.413-.998a2 2 0 0 1 1.099.092 10 10 0 1 0-4.777-4.719`,key:`1sd12s`}]]),gi=A(`monitor`,[[`rect`,{width:`20`,height:`14`,x:`2`,y:`3`,rx:`2`,key:`48i651`}],[`line`,{x1:`8`,x2:`16`,y1:`21`,y2:`21`,key:`1svkeh`}],[`line`,{x1:`12`,x2:`12`,y1:`17`,y2:`21`,key:`vw1qmm`}]]),_i=A(`phone`,[[`path`,{d:`M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233 14 14 0 0 0 6.392 6.384`,key:`9njp5v`}]]),vi=A(`search`,[[`path`,{d:`m21 21-4.34-4.34`,key:`14j7rj`}],[`circle`,{cx:`11`,cy:`11`,r:`8`,key:`4ej97u`}]]),yi=A(`send`,[[`path`,{d:`M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z`,key:`1ffxy3`}],[`path`,{d:`m21.854 2.147-10.94 10.939`,key:`12cjpa`}]]),bi=A(`shield-check`,[[`path`,{d:`M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z`,key:`oel41y`}],[`path`,{d:`m9 12 2 2 4-4`,key:`dzmm74`}]]),xi=A(`sparkles`,[[`path`,{d:`M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z`,key:`1s2grr`}],[`path`,{d:`M20 2v4`,key:`1rf3ol`}],[`path`,{d:`M22 4h-4`,key:`gwowj6`}],[`circle`,{cx:`4`,cy:`20`,r:`2`,key:`6kqj1y`}]]),Si=A(`star`,[[`path`,{d:`M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z`,key:`r04s7s`}]]),Ci=A(`trending-up`,[[`path`,{d:`M16 7h6v6`,key:`box55l`}],[`path`,{d:`m22 7-8.5 8.5-5-5L2 17`,key:`1t1m79`}]]),wi=A(`users`,[[`path`,{d:`M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2`,key:`1yyitq`}],[`path`,{d:`M16 3.128a4 4 0 0 1 0 7.744`,key:`16gr8j`}],[`path`,{d:`M22 21v-2a4 4 0 0 0-3-3.87`,key:`kshegd`}],[`circle`,{cx:`9`,cy:`7`,r:`4`,key:`nufk8`}]]),Ti=A(`video`,[[`path`,{d:`m16 13 5.223 3.482a.5.5 0 0 0 .777-.416V7.87a.5.5 0 0 0-.752-.432L16 10.5`,key:`ftymec`}],[`rect`,{x:`2`,y:`6`,width:`14`,height:`12`,rx:`2`,key:`158x01`}]]),Ei=A(`x`,[[`path`,{d:`M18 6 6 18`,key:`1bl5f8`}],[`path`,{d:`m6 6 12 12`,key:`d8bk6v`}]]),Di=o((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),j=o(((e,t)=>{t.exports=Di()}))(),Oi=[{to:`/`,label:`Ana Sayfa`},{to:`/hakkimda`,label:`Hakkımda`},{to:`/danismanlik`,label:`Danışmanlık`},{to:`/akademi`,label:`Akademi`},{to:`/beslenme-rehberi`,label:`Beslenme Rehberi`},{to:`/iletisim`,label:`İletişim`}],ki=()=>{let[e,t]=(0,_.useState)(!1),[n,r]=(0,_.useState)(!1),{pathname:i}=ht();return(0,_.useEffect)(()=>{let e=()=>t(window.scrollY>20);return window.addEventListener(`scroll`,e,{passive:!0}),()=>window.removeEventListener(`scroll`,e)},[]),(0,_.useEffect)(()=>{r(!1),window.scrollTo(0,0)},[i]),(0,_.useEffect)(()=>(document.body.style.overflow=n?`hidden`:``,()=>{document.body.style.overflow=``}),[n]),(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(`nav`,{className:`navbar${e?` navbar--scrolled`:``}${i===`/akademi`?` navbar--dark-page`:``}`,"aria-label":`Ana navigasyon`,children:(0,j.jsxs)(`div`,{className:`container navbar__inner`,children:[(0,j.jsx)(`div`,{className:`navbar__logo-spacer`}),(0,j.jsx)(`ul`,{className:`navbar__links`,role:`list`,children:Oi.map(e=>(0,j.jsx)(`li`,{children:(0,j.jsx)(k,{to:e.to,className:`navbar__link${i===e.to?` navbar__link--active`:``}`,"aria-current":i===e.to?`page`:void 0,children:e.label})},e.to))}),(0,j.jsx)(k,{to:`/iletisim`,className:`btn btn-primary navbar__cta`,children:`Bilgi Al`}),(0,j.jsx)(`button`,{className:`navbar__burger`,onClick:()=>r(!n),"aria-label":n?`Menüyü kapat`:`Menüyü aç`,"aria-expanded":n,id:`mobile-menu-toggle`,children:n?(0,j.jsx)(Ei,{size:22}):(0,j.jsx)(mi,{size:22})})]})}),n&&(0,j.jsx)(`div`,{className:`mobile-menu`,role:`dialog`,"aria-modal":`true`,"aria-label":`Mobil navigasyon`,children:(0,j.jsxs)(`ul`,{role:`list`,children:[Oi.map(e=>(0,j.jsx)(`li`,{children:(0,j.jsx)(k,{to:e.to,className:`mobile-menu__link${i===e.to?` mobile-menu__link--active`:``}`,children:e.label})},e.to)),(0,j.jsx)(`li`,{children:(0,j.jsx)(k,{to:`/iletisim`,className:`btn btn-primary mobile-menu__cta`,children:`Bilgi Al`})})]})}),(0,j.jsx)(`style`,{children:`
      ...
      `})]})},Ai=()=>{let e=new Date().getFullYear();return(0,j.jsxs)(`footer`,{className:`footer`,role:`contentinfo`,children:[(0,j.jsxs)(`div`,{className:`container`,children:[(0,j.jsxs)(`div`,{className:`footer__top`,children:[(0,j.jsxs)(`div`,{className:`footer__brand`,children:[(0,j.jsxs)(`div`,{className:`footer__logo`,children:[(0,j.jsxs)(`svg`,{width:`24`,height:`24`,viewBox:`0 0 44 44`,fill:`none`,"aria-hidden":`true`,children:[(0,j.jsx)(`path`,{d:`M22 6 C12 6 8 16 8 24 C8 32 15 38 22 38 C29 38 36 32 36 24 C36 16 32 6 22 6Z`,fill:`#E5C564`,opacity:`0.9`}),(0,j.jsx)(`path`,{d:`M22 6 C28 6 32 14 30 22 C28 30 22 36 16 34 C20 30 24 22 22 6Z`,fill:`#F7E9B0`,opacity:`0.8`}),(0,j.jsx)(`path`,{d:`M22 6 C20 2 16 2 14 4 C16 8 18 10 22 6Z`,fill:`#67826B`}),(0,j.jsx)(`path`,{d:`M22 6 C24 3 28 2 30 4 C28 8 26 10 22 6Z`,fill:`#4D6651`})]}),(0,j.jsx)(`span`,{children:`Ezgi Onaylı Küp`})]}),(0,j.jsxs)(`p`,{className:`footer__tagline`,children:[`Yeme davranışında beden ve zihin bütünlüğü.`,(0,j.jsx)(`br`,{}),`Sürdürülebilir kilo yönetimi.`]}),(0,j.jsxs)(`div`,{className:`footer__socials`,children:[(0,j.jsx)(`a`,{href:`https://www.instagram.com/diyetisyenezgionayli/`,target:`_blank`,rel:`noopener noreferrer`,className:`footer__social-link`,"aria-label":`Instagram'da takip edin`,children:(0,j.jsx)(ci,{size:18})}),(0,j.jsx)(`a`,{href:`https://wa.me/905542090903`,target:`_blank`,rel:`noopener noreferrer`,className:`footer__social-link`,"aria-label":`WhatsApp ile iletişim`,children:(0,j.jsx)(hi,{size:18})}),(0,j.jsx)(`a`,{href:`mailto:dytezgionayli@gmail.com`,className:`footer__social-link`,"aria-label":`E-posta gönder`,children:(0,j.jsx)(fi,{size:18})})]})]}),(0,j.jsxs)(`div`,{className:`footer__col`,children:[(0,j.jsx)(`h3`,{className:`footer__col-title`,children:`Sayfalar`}),(0,j.jsxs)(`ul`,{className:`footer__links`,children:[(0,j.jsx)(`li`,{children:(0,j.jsx)(k,{to:`/`,children:`Ana Sayfa`})}),(0,j.jsx)(`li`,{children:(0,j.jsx)(k,{to:`/hakkimda`,children:`Hakkımda`})}),(0,j.jsx)(`li`,{children:(0,j.jsx)(k,{to:`/danismanlik`,children:`Danışmanlık`})}),(0,j.jsx)(`li`,{children:(0,j.jsx)(k,{to:`/online-danismanlik`,children:`Online Danışmanlık`})}),(0,j.jsx)(`li`,{children:(0,j.jsx)(k,{to:`/akademi`,children:`Akademi`})}),(0,j.jsx)(`li`,{children:(0,j.jsx)(k,{to:`/beslenme-rehberi`,children:`Beslenme Rehberi`})}),(0,j.jsx)(`li`,{children:(0,j.jsx)(k,{to:`/iletisim`,children:`İletişim`})})]})]}),(0,j.jsxs)(`div`,{className:`footer__col`,children:[(0,j.jsx)(`h3`,{className:`footer__col-title`,children:`İletişim`}),(0,j.jsxs)(`ul`,{className:`footer__contact`,children:[(0,j.jsxs)(`li`,{children:[(0,j.jsx)(pi,{size:15,"aria-hidden":`true`}),(0,j.jsxs)(`span`,{children:[`Bağlarbaşı Mah. Başçılar Sok. No:1 Daire:9 (Life 226)`,(0,j.jsx)(`br`,{}),(0,j.jsx)(`small`,{children:`Yalova`})]})]}),(0,j.jsxs)(`li`,{children:[(0,j.jsx)(_i,{size:15,"aria-hidden":`true`}),(0,j.jsx)(`a`,{href:`tel:+905542090903`,children:`+90 (554) 209 09 03`})]}),(0,j.jsxs)(`li`,{children:[(0,j.jsx)(fi,{size:15,"aria-hidden":`true`}),(0,j.jsx)(`a`,{href:`mailto:dytezgionayli@gmail.com`,children:`dytezgionayli@gmail.com`})]}),(0,j.jsxs)(`li`,{children:[(0,j.jsx)(hi,{size:15,"aria-hidden":`true`}),(0,j.jsx)(`a`,{href:`https://wa.me/905542090903`,target:`_blank`,rel:`noopener noreferrer`,children:`WhatsApp ile ulaşın`})]})]})]})]}),(0,j.jsx)(`div`,{className:`footer__divider`}),(0,j.jsxs)(`div`,{className:`footer__bottom`,children:[(0,j.jsxs)(`p`,{children:[`© `,e,` Diyetisyen Ezgi Onaylı Küp · Tüm hakları saklıdır.`]}),(0,j.jsxs)(`div`,{className:`footer__legal`,children:[(0,j.jsx)(k,{to:`/kvkk`,children:`KVKK`}),(0,j.jsx)(`span`,{children:`·`}),(0,j.jsx)(k,{to:`/gizlilik`,children:`Gizlilik Politikası`}),(0,j.jsx)(`span`,{children:`·`}),(0,j.jsx)(k,{to:`/cerez`,children:`Çerez Politikası`})]}),(0,j.jsxs)(`p`,{className:`footer__made`,children:[(0,j.jsx)(di,{size:12,"aria-hidden":`true`}),` Sağlıklı yaşam için`]})]})]}),(0,j.jsx)(`style`,{children:`
        .footer {
      ...
      `})]})},ji=({children:e})=>(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(ki,{}),(0,j.jsx)(`main`,{id:`main-content`,tabIndex:-1,children:e}),(0,j.jsx)(Ai,{})]}),Mi=`/ezgi-onayli-kup/assets/ezgi-portrait-new-BMjJ0_w8.jpg`,Ni=`/ezgi-onayli-kup/assets/face-to-face-ChPTKz8h.png`,Pi=`/ezgi-onayli-kup/assets/online-consulting-gChqu92w.png`,Fi=`/ezgi-onayli-kup/assets/insta-profile-BiZJ-F1j.png`,Ii=`/ezgi-onayli-kup/assets/hero-plant-topleft-BUgLaw15.jpg`,Li=`/ezgi-onayli-kup/assets/hero-sea-bottomright-CErIaRDf.jpg`,Ri=`/ezgi-onayli-kup/assets/blog-mediterranean-CM12zNqg.png`,zi=`/ezgi-onayli-kup/assets/blog-weight-CNZu_FGU.png`,M=[{id:`1`,slug:`akdeniz-tipi-beslenme-nedir`,title:`Akdeniz Tipi Beslenme Nedir? Neden Bu Kadar Önemli?`,excerpt:`Akdeniz tipi beslenme, bilimsel araştırmalarla desteklenen ve sürdürülebilirliğiyle öne çıkan bir beslenme yaklaşımıdır. Yüzyıllardır Akdeniz coğrafyasında yaşayan toplulukların yaşam biçiminden ilham alan bu model, sağlıklı yağları, sebze-meyveyi ve tam tahılları ön plana çıkarır.`,content:`
...
*Bu yazı genel bilgilendirme amaçlıdır. Kişiye özel beslenme planı için uzman diyetisyen desteği almanız önerilir.*
    `,category:`yazı`,readTime:5,publishedAt:`2025-03-15`,image:Ri,imageAlt:`Akdeniz tipi beslenme yiyecekleri`},{id:`2`,slug:`yeme-davranisi-nedir`,title:`Yeme Davranışını Anlamak: Zihin ve Beden Bağlantısı`,excerpt:`Neden aç olmadan yiyoruz? Duygular beslenme davranışımızı nasıl şekillendiriyor? Yeme davranışını anlamak, sürdürülebilir bir beslenme düzeni kurmanın ilk adımıdır.`,content:`
...
*Bu yazı genel bilgilendirme amaçlıdır.*
    `,category:`yazı`,readTime:6,publishedAt:`2025-04-02`,image:zi,imageAlt:`Dikkatli yeme ve zihin bağlantısı`},{id:`3`,slug:`gunluk-su-ihtiyaci`,title:`Günlük Ne Kadar Su İçmeliyiz?`,excerpt:`Su, vücudumuzun temel yapı taşıdır. Yeterli su tüketimi metabolizma, enerji düzeyi ve genel sağlık için kritik önemdedir. Peki gerçekten ne kadar su içmeliyiz?`,content:`
...
*Bu yazı genel bilgilendirme amaçlıdır.*
    `,category:`yazı`,readTime:7,publishedAt:`2025-06-01`,image:zi,imageAlt:`Sürdürülebilir beslenme`}],N=[{icon:(0,j.jsx)(xi,{size:24}),title:`Sürdürülebilir Kilo Yönetimi`,desc:`Kısa vadeli değil, uzun vadeli ve sürdürülebilir çözümler.`},{icon:(0,j.jsx)(di,{size:24}),title:`Sağlıklı Beslenme`,desc:`Yaşam tarzınıza uygun, dengeli ve sağlıklı beslenme planları.`},{icon:(0,j.jsx)(gi,{size:24}),title:`Online Danışmanlık`,desc:`Türkiye'nin her yerinden online görüşme ve takip imkânı.`},{icon:(0,j.jsx)(Si,{size:24}),title:`Beslenme Alışkanlıklarını Düzenleme`,desc:`Yeme davranışını anlamaya ve dönüştürmeye yönelik bütüncül yaklaşım.`},{icon:(0,j.jsx)(ai,{size:24}),title:`Kişiye Özel Programlar`,desc:`Hedeflerinize, yaşamınıza ve ihtiyaçlarınıza özel beslenme planları.`},{icon:(0,j.jsx)(bi,{size:24}),title:`Yeme Davranışı Danışmanlığı`,desc:`Duygusal yeme, sağlıklı alışkanlıklar ve farkındalık üzerine çalışmalar.`}],P=M.slice(0,4),Bi=()=>((0,_.useEffect)(()=>{let e=document.querySelectorAll(`.reveal`),t=new IntersectionObserver(e=>e.forEach(e=>{e.isIntersecting&&(e.target.classList.add(`visible`),t.unobserve(e.target))}),{threshold:.1});return e.forEach(e=>t.observe(e)),()=>t.disconnect()},[]),(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(Ur,{children:[(0,j.jsx)(`title`,{children:`Diyetisyen Ezgi Onaylı Küp | Beslenme & Sağlıklı Yaşam`}),(0,j.jsx)(`meta`,{name:`description`,content:`Diyetisyen Ezgi Onaylı Küp — Yeme davranışında beden ve zihin bütünlüğü. Yalova'da yüz yüze, Türkiye'nin her yerinden online beslenme danışmanlığı.`}),(0,j.jsx)(`meta`,{property:`og:title`,content:`Diyetisyen Ezgi Onaylı Küp`}),(0,j.jsx)(`meta`,{property:`og:description`,content:`Yeme davranışında beden ve zihin bütünlüğü. Sürdürülebilir kilo yönetimi.`}),(0,j.jsx)(`script`,{type:`application/ld+json`,children:JSON.stringify({"@context":`https://schema.org`,"@type":`Person`,name:`Ezgi Onaylı Küp`,jobTitle:`Diyetisyen`,url:`https://ezgionaylikup.com`,description:`Yeme davranışında beden ve zihin bütünlüğü.`,address:{"@type":`PostalAddress`,streetAddress:`Bağlarbaşı Mah. Başçılar Sok. No:1 Daire:9 (Life 226)`,addressLocality:`Yalova`,addressCountry:`TR`},telephone:`+905542090903`})})]}),(0,j.jsxs)(`section`,{className:`hero`,"aria-label":`Ana başlık bölümü`,children:[(0,j.jsx)(`div`,{className:`hero-top-left-plant`,"aria-hidden":`true`,children:(0,j.jsx)(`img`,{src:Ii,alt:``,className:`hero-plant-img`})}),(0,j.jsx)(`div`,{className:`hero-bottom-right-sea`,"aria-hidden":`true`,children:(0,j.jsx)(`img`,{src:Li,alt:``,className:`hero-sea-img`})}),(0,j.jsx)(`div`,{className:`container hero__inner`,children:(0,j.jsxs)(`div`,{className:`hero__content animate-fade-up`,children:[(0,j.jsxs)(`div`,{className:`hero-centered-brand text-center mb-6`,children:[(0,j.jsx)(`div`,{className:`hero-lemon-icon-mark mb-2`,children:(0,j.jsxs)(`svg`,{width:`24`,height:`24`,viewBox:`0 0 44 44`,fill:`none`,"aria-hidden":`true`,children:[(0,j.jsx)(`path`,{d:`M22 6 C12 6 8 16 8 24 C8 32 15 38 22 38 C29 38 36 32 36 24 C36 16 32 6 22 6Z`,fill:`#E5C564`,opacity:`0.9`}),(0,j.jsx)(`path`,{d:`M22 6 C28 6 32 14 30 22 C28 30 22 36 16 34 C20 30 24 22 22 6Z`,fill:`#F7E9B0`,opacity:`0.8`}),(0,j.jsx)(`path`,{d:`M22 6 C20 2 16 2 14 4 C16 8 18 10 22 6Z`,fill:`#67826B`}),(0,j.jsx)(`path`,{d:`M22 6 C24 3 28 2 30 4 C28 8 26 10 22 6Z`,fill:`#4D6651`})]})}),(0,j.jsx)(`p`,{className:`hero-brand-subtitle`,children:`D İ Y E T İ S Y E N`}),(0,j.jsx)(`h1`,{className:`hero-brand-title`,children:`Ezgi Onaylı Küp`}),(0,j.jsx)(`div`,{className:`hero-brand-divider`,children:(0,j.jsx)(`span`,{className:`dot`})})]}),(0,j.jsx)(`div`,{className:`text-center mb-6`,children:(0,j.jsxs)(`span`,{className:`badge badge-aqua hero__badge mx-auto`,children:[(0,j.jsx)(di,{size:12}),` YALOVA & TÜRKİYE GENELİ`]})}),(0,j.jsxs)(`h2`,{className:`hero__title text-center`,children:[`Yeme davranışında`,(0,j.jsx)(`br`,{}),(0,j.jsx)(`span`,{className:`hero-title-script`,children:`beden ve zihin`}),(0,j.jsx)(`br`,{}),`bütünlüğü.`]}),(0,j.jsxs)(`p`,{className:`hero__subtitle text-center`,children:[`Yalova'daki kliniğimde yüz yüze,`,(0,j.jsx)(`br`,{}),`Türkiye'nin her yerinden online beslenme danışmanlığı.`]}),(0,j.jsxs)(`div`,{className:`hero__ctas justify-center`,children:[(0,j.jsxs)(k,{to:`/online-danismanlik`,className:`btn btn-primary btn--lg hero-btn-pill`,id:`hero-online-btn`,children:[`Online Danışmanlık`,(0,j.jsx)(ei,{size:18})]}),(0,j.jsx)(k,{to:`/iletisim`,className:`btn btn-secondary btn--lg hero-btn-pill`,id:`hero-contact-btn`,children:`Benimle İletişime Geç`})]}),(0,j.jsxs)(`div`,{className:`hero-trust-bar`,children:[(0,j.jsxs)(`div`,{className:`hero-trust-column`,children:[(0,j.jsx)(pi,{size:22,className:`hero-trust-icon`}),(0,j.jsx)(`span`,{children:`Yalova Kliniği`})]}),(0,j.jsx)(`div`,{className:`hero-trust-divider`}),(0,j.jsxs)(`div`,{className:`hero-trust-column`,children:[(0,j.jsx)(gi,{size:22,className:`hero-trust-icon`}),(0,j.jsx)(`span`,{children:`Online Görüşme`})]}),(0,j.jsx)(`div`,{className:`hero-trust-divider`}),(0,j.jsxs)(`div`,{className:`hero-trust-column`,children:[(0,j.jsx)(di,{size:22,className:`hero-trust-icon`}),(0,j.jsx)(`span`,{children:`Kişiye Özel Program`})]})]})]})})]}),(0,j.jsx)(`section`,{className:`section bg-white`,"aria-label":`Hizmetler`,children:(0,j.jsxs)(`div`,{className:`container`,children:[(0,j.jsxs)(`div`,{className:`section-header section-header--center reveal`,children:[(0,j.jsx)(`div`,{className:`section-eyebrow`,children:`Sana Nasıl Yardımcı Olabilirim?`}),(0,j.jsxs)(`h2`,{className:`section-title`,children:[`Birlikte `,(0,j.jsx)(`em`,{children:`neler çalışabiliriz`})]}),(0,j.jsx)(`p`,{className:`section-subtitle`,children:`Beslenme danışmanlığını sadece diyet listesi vermek olarak görmüyorum. Beden, zihin ve yaşam tarzını bir bütün olarak değerlendiriyorum.`})]}),(0,j.jsx)(`div`,{className:`services-grid reveal`,children:N.map((e,t)=>(0,j.jsxs)(`div`,{className:`service-card`,style:{animationDelay:`${t*.08}s`},children:[(0,j.jsx)(`div`,{className:`service-card__icon`,"aria-hidden":`true`,children:e.icon}),(0,j.jsx)(`h3`,{className:`service-card__title`,children:e.title}),(0,j.jsx)(`p`,{className:`service-card__desc`,children:e.desc})]},t))})]})}),(0,j.jsx)(`section`,{className:`section about-section`,"aria-label":`Hakkımda ve beslenme felsefem`,children:(0,j.jsxs)(`div`,{className:`container`,children:[(0,j.jsxs)(`div`,{className:`about-preview`,children:[(0,j.jsx)(`div`,{className:`about-preview__img-col reveal`,children:(0,j.jsxs)(`div`,{className:`about-preview__img-wrapper`,children:[(0,j.jsx)(`img`,{src:Mi,alt:`Diyetisyen Ezgi Onaylı Küp — Profesyonel portre`,className:`about-preview__img`}),(0,j.jsx)(`div`,{className:`about-preview__img-bg-deco`,"aria-hidden":`true`})]})}),(0,j.jsxs)(`div`,{className:`about-preview__content reveal`,children:[(0,j.jsxs)(`div`,{className:`about-preview__header mb-6`,children:[(0,j.jsx)(`div`,{className:`section-eyebrow script-eyebrow mb-1`,children:`Merhaba!`}),(0,j.jsxs)(`h2`,{className:`section-title mb-3`,children:[`Ben Diyetisyen`,(0,j.jsx)(`br`,{}),(0,j.jsx)(`span`,{className:`ezgi-script-title`,children:`Ezgi Onaylı Küp.`})]}),(0,j.jsxs)(`div`,{className:`about-motto-pill mt-3`,children:[(0,j.jsx)(di,{size:14,color:`var(--color-sage-dark)`}),(0,j.jsx)(`span`,{children:`Yasaklarla değil, farkındalıkla değişim.`})]})]}),(0,j.jsxs)(`div`,{className:`about-preview__body mb-6`,children:[(0,j.jsx)(`p`,{children:`Sağlıklı bir yaşamın, yasaklarla değil farkındalıkla mümkün olduğuna inanıyorum. Sürdürülebilir, dengeli ve besleyici bir yaşam tarzı için buradayım.`}),(0,j.jsx)(`p`,{children:`Bilimsel yaklaşım, gerçekçi planlar ve sana özel destekle; sadece kilo vermeyi değil, kendinle barışık bir yaşamı hedefliyoruz. Birlikte, sana iyi gelen seçimlerle güçlü bir dönüşüm yaratabiliriz.`})]}),(0,j.jsx)(`div`,{className:`poster-quote-box mb-8`,children:(0,j.jsxs)(`p`,{className:`poster-quote-text`,children:[`"Sadece kilo vermek değil, `,(0,j.jsx)(`em`,{children:`kendinle barışmak.`}),`"`]})}),(0,j.jsx)(`div`,{className:`about-preview__actions pt-2`,children:(0,j.jsxs)(k,{to:`/hakkimda`,className:`btn btn-sage btn--lg`,id:`about-preview-btn`,children:[`Hakkımda Daha Fazla`,(0,j.jsx)(ei,{size:16})]})})]})]}),(0,j.jsx)(`div`,{className:`poster-features-grid reveal mt-16`,children:[{icon:(0,j.jsx)(di,{size:22}),title:`KİŞİYE ÖZEL BESLENME PLANI`,desc:`Sana ve yaşam tarzına özel besleyici beslenme planı`},{icon:(0,j.jsx)(oi,{size:22}),title:`DÜZENLİ TAKİP VE DESTEK`,desc:`Haftalık seanslar ve kesintisiz iletişim desteği`},{icon:(0,j.jsx)(Ci,{size:22}),title:`BİLİMSEL VE SÜRDÜRÜLEBİLİR`,desc:`Kanıta dayalı, kalıcı sonuç hedefleyen yaklaşım`},{icon:(0,j.jsx)(xi,{size:22}),title:`SAĞLIKLI YAŞAM`,desc:`Bedeni ve zihni dengeye kavuşturan bütüncül yaşam`}].map((e,t)=>(0,j.jsxs)(`div`,{className:`poster-feature-card`,children:[(0,j.jsx)(`div`,{className:`poster-feature-icon`,children:e.icon}),(0,j.jsx)(`h4`,{className:`poster-feature-title`,children:e.title}),(0,j.jsx)(`p`,{className:`poster-feature-desc`,children:e.desc})]},t))})]})}),(0,j.jsx)(`section`,{className:`section bg-cream-dark`,"aria-label":`Danışmanlık seçenekleri`,children:(0,j.jsxs)(`div`,{className:`container`,children:[(0,j.jsxs)(`div`,{className:`section-header section-header--center reveal`,children:[(0,j.jsx)(`div`,{className:`section-eyebrow`,children:`Nasıl Çalışabiliriz?`}),(0,j.jsxs)(`h2`,{className:`section-title`,children:[`İki farklı `,(0,j.jsx)(`em`,{children:`danışmanlık seçeneği`})]})]}),(0,j.jsxs)(`div`,{className:`consulting-grid reveal`,children:[(0,j.jsxs)(`div`,{className:`consulting-card`,children:[(0,j.jsx)(`div`,{className:`consulting-card__icon`,children:(0,j.jsx)(pi,{size:28})}),(0,j.jsx)(`div`,{className:`consulting-card__img`,children:(0,j.jsx)(`img`,{src:Ni,alt:`Yüz yüze danışmanlık — Yalova kliniği`})}),(0,j.jsxs)(`div`,{className:`consulting-card__body`,children:[(0,j.jsx)(`span`,{className:`badge badge-sage`,children:`Yalova Kliniği`}),(0,j.jsx)(`h3`,{children:`Yüz Yüze Danışmanlık`}),(0,j.jsx)(`ul`,{className:`checklist`,children:[`Kapsamlı kişisel değerlendirme`,`Ölçüm ve analiz`,`Kişiye özel beslenme programı`,`Düzenli takip ve motivasyon`].map(e=>(0,j.jsxs)(`li`,{className:`checklist-item`,children:[(0,j.jsx)(`div`,{className:`checklist-icon`,children:(0,j.jsx)(ai,{size:12,color:`var(--color-sage)`})}),e]},e))}),(0,j.jsxs)(k,{to:`/danismanlik`,className:`btn btn-sage`,id:`face-to-face-btn`,children:[`Detaylı Bilgi `,(0,j.jsx)(ei,{size:15})]})]})]}),(0,j.jsxs)(`div`,{className:`consulting-card consulting-card--aqua`,children:[(0,j.jsx)(`div`,{className:`consulting-card__icon`,children:(0,j.jsx)(gi,{size:28})}),(0,j.jsx)(`div`,{className:`consulting-card__img`,children:(0,j.jsx)(`img`,{src:Pi,alt:`Online danışmanlık — video görüşme`})}),(0,j.jsxs)(`div`,{className:`consulting-card__body`,children:[(0,j.jsx)(`span`,{className:`badge badge-aqua`,children:`Türkiye'nin Her Yerinden`}),(0,j.jsx)(`h3`,{children:`Online Danışmanlık`}),(0,j.jsx)(`ul`,{className:`checklist`,children:[`Online görüşme`,`Kişiye özel beslenme programı`,`Düzenli takip ve değerlendirme`,`Sürekli iletişim desteği`].map(e=>(0,j.jsxs)(`li`,{className:`checklist-item`,children:[(0,j.jsx)(`div`,{className:`checklist-icon`,children:(0,j.jsx)(ai,{size:12,color:`var(--color-aqua)`})}),e]},e))}),(0,j.jsxs)(k,{to:`/online-danismanlik`,className:`btn btn-primary`,id:`online-consulting-btn`,children:[`Detaylı Bilgi `,(0,j.jsx)(ei,{size:15})]})]})]})]})]})}),(0,j.jsx)(`section`,{className:`section bg-white`,"aria-label":`Program seçeneklerimiz`,children:(0,j.jsxs)(`div`,{className:`container`,children:[(0,j.jsxs)(`div`,{className:`section-header section-header--center reveal`,children:[(0,j.jsx)(`div`,{className:`section-eyebrow`,children:`Beslenme Paketleri`}),(0,j.jsxs)(`h2`,{className:`section-title`,children:[`Program `,(0,j.jsx)(`em`,{children:`Seçeneklerimiz`})]}),(0,j.jsx)(`p`,{className:`section-subtitle`,children:`Hedeflerinize ve yaşam temponuza en uygun süreyi seçerek hemen danışmanlığa başlayabilirsiniz.`})]}),(0,j.jsx)(`div`,{className:`program-options-grid reveal`,children:[{duration:`1 AYLIK PROGRAM`,sessions:`4 SEANS`,popular:!1},{duration:`2 AYLIK PROGRAM`,sessions:`8 SEANS`,popular:!0},{duration:`3 AYLIK PROGRAM`,sessions:`12 SEANS`,popular:!1}].map((e,t)=>(0,j.jsxs)(`div`,{className:`program-card ${e.popular?`program-card--popular`:``}`,children:[e.popular&&(0,j.jsx)(`span`,{className:`program-card__badge-popular`,children:`En Çok Tercih Edilen`}),(0,j.jsx)(`div`,{className:`program-card__duration`,children:e.duration}),(0,j.jsxs)(`div`,{className:`program-card__sessions-badge`,children:[(0,j.jsx)(ii,{size:18}),(0,j.jsx)(`span`,{children:e.sessions})]}),(0,j.jsx)(`div`,{className:`program-card__divider`}),(0,j.jsxs)(`a`,{href:`https://wa.me/905542090903`,target:`_blank`,rel:`noopener noreferrer`,className:`btn w-full justify-center ${e.popular?`btn-primary`:`btn-secondary`}`,id:`program-btn-${t+1}`,children:[`Bilgi Al & Başla `,(0,j.jsx)(ei,{size:16})]})]},t))}),(0,j.jsx)(`div`,{className:`program-options-footer text-center reveal mt-8`,children:(0,j.jsxs)(`div`,{className:`program-footer-pill`,children:[(0,j.jsx)(di,{size:16,color:`var(--color-sage-dark)`}),(0,j.jsx)(`span`,{children:`Tüm programlarımızda haftalık düzenli seanslar ile takip, motivasyon ve kalıcı sonuç hedeflenir.`})]})})]})}),(0,j.jsx)(`section`,{className:`section bg-white`,"aria-label":`Beslenme Rehberi son yazılar`,children:(0,j.jsxs)(`div`,{className:`container`,children:[(0,j.jsxs)(`div`,{className:`section-header section-header--center reveal`,children:[(0,j.jsx)(`div`,{className:`section-eyebrow`,children:`Beslenme Rehberi`}),(0,j.jsxs)(`h2`,{className:`section-title`,children:[`Güncel `,(0,j.jsx)(`em`,{children:`içerikler`})]}),(0,j.jsx)(`p`,{className:`section-subtitle`,children:`Bilimsel temelli yazılar, beslenme rehberleri ve pratik öneriler.`})]}),(0,j.jsx)(`div`,{className:`blog-preview-grid reveal`,children:P.map(e=>(0,j.jsxs)(`article`,{className:`blog-card`,children:[(0,j.jsx)(k,{to:`/beslenme-rehberi/${e.slug}`,className:`blog-card__img-link`,"aria-label":e.title,children:(0,j.jsx)(`div`,{className:`blog-card__img`,children:(0,j.jsx)(`img`,{src:e.image,alt:e.imageAlt})})}),(0,j.jsxs)(`div`,{className:`blog-card__body`,children:[(0,j.jsx)(`span`,{className:`badge badge-sage`,children:e.category}),(0,j.jsx)(`h3`,{className:`blog-card__title`,children:(0,j.jsx)(k,{to:`/beslenme-rehberi/${e.slug}`,children:e.title})}),(0,j.jsxs)(`p`,{className:`blog-card__excerpt`,children:[e.excerpt.substring(0,100),`…`]}),(0,j.jsxs)(`div`,{className:`blog-card__footer`,children:[(0,j.jsxs)(`span`,{className:`blog-card__read-time`,children:[e.readTime,` dk okuma`]}),(0,j.jsxs)(k,{to:`/beslenme-rehberi/${e.slug}`,className:`blog-card__cta`,children:[`Devamını Oku `,(0,j.jsx)(ei,{size:13})]})]})]})]},e.id))}),(0,j.jsx)(`div`,{className:`text-center mt-12 reveal`,children:(0,j.jsxs)(k,{to:`/beslenme-rehberi`,className:`btn btn-ghost btn--lg`,id:`all-posts-btn`,children:[`Tüm Yazıları Gör `,(0,j.jsx)(ei,{size:16})]})})]})}),(0,j.jsx)(`section`,{className:`section bg-cream-dark`,"aria-label":`Instagram Topluluğumuz`,children:(0,j.jsxs)(`div`,{className:`container`,children:[(0,j.jsxs)(`div`,{className:`section-header section-header--center reveal`,children:[(0,j.jsx)(`div`,{className:`section-eyebrow`,children:`Sosyal Medya`}),(0,j.jsxs)(`h2`,{className:`section-title`,children:[`Instagram'da `,(0,j.jsx)(`em`,{children:`Buluşalım`})]}),(0,j.jsx)(`p`,{className:`section-subtitle`,children:`Günlük beslenme ipuçları, yeme davranışı farkındalıkları ve sağlıklı yaşam içeriklerim için beni Instagram'da takip edebilirsiniz.`})]}),(0,j.jsxs)(`div`,{className:`insta-native-app-card reveal`,children:[(0,j.jsxs)(`div`,{className:`insta-header-row`,children:[(0,j.jsx)(`div`,{className:`insta-avatar-col`,children:(0,j.jsx)(`div`,{className:`insta-story-ring`,children:(0,j.jsx)(`img`,{src:Fi,alt:`Diyetisyen Ezgi Onaylı Küp`,className:`insta-profile-photo`})})}),(0,j.jsxs)(`div`,{className:`insta-counts-col`,children:[(0,j.jsxs)(`div`,{className:`insta-stat flex-col`,children:[(0,j.jsx)(`span`,{className:`stat-num`,children:`1.240`}),(0,j.jsx)(`span`,{className:`stat-label`,children:`gönderi`})]}),(0,j.jsxs)(`div`,{className:`insta-stat flex-col`,children:[(0,j.jsx)(`span`,{className:`stat-num`,children:`15.8k`}),(0,j.jsx)(`span`,{className:`stat-label`,children:`takipçi`})]}),(0,j.jsxs)(`div`,{className:`insta-stat flex-col`,children:[(0,j.jsx)(`span`,{className:`stat-num`,children:`480`}),(0,j.jsx)(`span`,{className:`stat-label`,children:`takip`})]})]})]}),(0,j.jsxs)(`div`,{className:`insta-bio-block`,children:[(0,j.jsxs)(`div`,{className:`insta-name-line`,children:[(0,j.jsx)(`h3`,{className:`insta-real-name`,children:`Diyetisyen Ezgi Onaylı Küp`}),(0,j.jsx)(`span`,{className:`insta-badge-check`,children:`✓`})]}),(0,j.jsx)(`span`,{className:`insta-handle-sub`,children:`@diyetisyenezgionayli · Sağlık & Beslenme`}),(0,j.jsxs)(`p`,{className:`insta-bio-text`,children:[`🌿 Yeme davranışında beden ve zihin bütünlüğü.`,(0,j.jsx)(`br`,{}),`📍 Yalova Kliniği & Online Danışmanlık`,(0,j.jsx)(`br`,{}),`🌱 Sürdürülebilir kilo yönetimi ve beslenme farkındalığı.`]}),(0,j.jsx)(`a`,{href:`https://www.instagram.com/diyetisyenezgionayli/`,target:`_blank`,rel:`noopener noreferrer`,className:`insta-bio-url`,children:`instagram.com/diyetisyenezgionayli/`})]}),(0,j.jsxs)(`div`,{className:`insta-actions-bar`,children:[(0,j.jsx)(`a`,{href:`https://www.instagram.com/diyetisyenezgionayli/`,target:`_blank`,rel:`noopener noreferrer`,className:`insta-btn insta-btn-primary`,children:`Takip Et`}),(0,j.jsx)(`a`,{href:`https://www.instagram.com/diyetisyenezgionayli/`,target:`_blank`,rel:`noopener noreferrer`,className:`insta-btn insta-btn-secondary`,children:`Mesaj Gönder`})]}),(0,j.jsx)(`div`,{className:`insta-tab-strip`,children:(0,j.jsxs)(`div`,{className:`insta-tab active`,children:[(0,j.jsxs)(`svg`,{width:`20`,height:`20`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,children:[(0,j.jsx)(`rect`,{x:`3`,y:`3`,width:`7`,height:`7`}),(0,j.jsx)(`rect`,{x:`14`,y:`3`,width:`7`,height:`7`}),(0,j.jsx)(`rect`,{x:`14`,y:`14`,width:`7`,height:`7`}),(0,j.jsx)(`rect`,{x:`3`,y:`14`,width:`7`,height:`7`})]}),(0,j.jsx)(`span`,{children:`GÖNDERİLER`})]})}),(0,j.jsx)(`div`,{className:`behold-widget-wrapper`,children:(0,j.jsx)(`figure`,{className:`behold-container`,children:(0,j.jsx)(`behold-widget`,{"feed-id":`5tcJsdosJ80J99KIq1dP`})})})]})]})}),(0,j.jsx)(`section`,{className:`section academy-teaser`,"aria-label":`Ezgi Onaylı Küp Akademi`,children:(0,j.jsx)(`div`,{className:`container`,children:(0,j.jsx)(`div`,{className:`academy-teaser__inner reveal`,children:(0,j.jsxs)(`div`,{className:`academy-teaser__content`,children:[(0,j.jsx)(`span`,{className:`badge badge-lemon`,children:`Yakında`}),(0,j.jsxs)(`h2`,{className:`section-title`,style:{color:`white`},children:[`Ezgi Onaylı Küp `,(0,j.jsx)(`em`,{style:{color:`var(--color-lemon)`},children:`Akademi`})]}),(0,j.jsx)(`p`,{style:{color:`rgba(250,247,242,0.75)`,fontSize:`var(--text-lg)`,lineHeight:1.7,marginBottom:`var(--space-6)`},children:`E-kitaplar, beslenme rehberleri, video eğitimler ve çok daha fazlası yakında burada olacak.`}),(0,j.jsx)(`div`,{className:`academy-teaser__features`,children:[{icon:(0,j.jsx)(ni,{size:18}),text:`E-Kitaplar & Rehberler`},{icon:(0,j.jsx)(Ti,{size:18}),text:`Video Eğitimler`},{icon:(0,j.jsx)(wi,{size:18}),text:`Grup Çalışmaları`}].map(e=>(0,j.jsxs)(`div`,{className:`academy-feature`,children:[e.icon,(0,j.jsx)(`span`,{children:e.text})]},e.text))}),(0,j.jsxs)(k,{to:`/akademi`,className:`btn btn--lg academy-teaser__btn`,id:`academy-teaser-btn`,children:[`Akademiye Göz At `,(0,j.jsx)(ei,{size:18})]})]})})})}),(0,j.jsx)(`section`,{className:`section--sm`,"aria-label":`İletişim çağrısı`,children:(0,j.jsx)(`div`,{className:`container`,children:(0,j.jsxs)(`div`,{className:`contact-cta reveal`,children:[(0,j.jsx)(`div`,{children:(0,j.jsxs)(`h2`,{className:`contact-cta__title`,children:[`Benimle iletişime geç,`,(0,j.jsx)(`br`,{}),(0,j.jsx)(`em`,{children:`sağlıklı ve mutlu bir sen'e ilk adımı at.`})]})}),(0,j.jsxs)(`div`,{className:`contact-cta__actions`,children:[(0,j.jsx)(`a`,{href:`https://wa.me/905542090903`,target:`_blank`,rel:`noopener noreferrer`,className:`btn btn-primary btn--lg`,id:`whatsapp-cta-btn`,children:`WhatsApp ile Yaz`}),(0,j.jsx)(k,{to:`/iletisim`,className:`btn btn-secondary btn--lg`,id:`contact-cta-btn`,children:`Randevu Talebi`})]})]})})}),(0,j.jsx)(`style`,{children:`
        /* ── HERO ── */
        .hero {
          min-height: 100vh;
      ...
      `})]})),Vi=[{year:`20XX`,title:`Beslenme ve Diyetetik Lisans`,institution:`Üniversite Adı`,desc:`Beslenme bilimleri alanında lisans eğitimi tamamlandı.`},{year:`20XX`,title:`Yüksek Lisans / Uzmanlık Eğitimi`,institution:`Kurum Adı`,desc:`Yeme davranışı ve kilo yönetimi üzerine ileri çalışmalar.`}],Hi=[{year:`20XX–20XX`,title:`Klinik Diyetisyen`,institution:`Kurum Adı`,desc:`Klinik beslenme alanında çalışmalar.`},{year:`20XX–Halen`,title:`Serbest Diyetisyen`,institution:`Ezgi Onaylı Küp Kliniği — Yalova`,desc:`Yüz yüze ve online beslenme danışmanlığı hizmetleri.`}],Ui=[{icon:(0,j.jsx)(xi,{size:22}),title:`Bütüncül Yaklaşım`,desc:`Beslenmeyi sadece yiyecek seçimleri olarak değil; duygular, alışkanlıklar, yaşam tarzı ve beden-zihin bütünlüğü çerçevesinde ele alıyorum.`},{icon:(0,j.jsx)(li,{size:22}),title:`Bilimsel Temel`,desc:`Her önerim güncel bilimsel literatüre dayanır. Kanıt temelli beslenme yaklaşımı, çalışmamın temelini oluşturur.`},{icon:(0,j.jsx)(ri,{size:22}),title:`Kişiye Özellik`,desc:`Genel kalıplar yerine, her danışanın kendine özgü ihtiyaçlarını, hedeflerini ve yaşam koşullarını dikkate alarak plan oluştururum.`}],Wi=()=>((0,_.useEffect)(()=>{let e=document.querySelectorAll(`.reveal`),t=new IntersectionObserver(e=>e.forEach(e=>{e.isIntersecting&&(e.target.classList.add(`visible`),t.unobserve(e.target))}),{threshold:.1});return e.forEach(e=>t.observe(e)),()=>t.disconnect()},[]),(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(Ur,{children:[(0,j.jsx)(`title`,{children:`Hakkımda | Diyetisyen Ezgi Onaylı Küp`}),(0,j.jsx)(`meta`,{name:`description`,content:`Diyetisyen Ezgi Onaylı Küp hakkında: eğitim geçmişi, mesleki deneyim ve beslenme danışmanlığı yaklaşımı.`})]}),(0,j.jsxs)(`header`,{className:`page-header`,children:[(0,j.jsxs)(`div`,{className:`container`,children:[(0,j.jsx)(`p`,{className:`page-header__eyebrow animate-fade-up`,children:`Hakkımda`}),(0,j.jsxs)(`h1`,{className:`page-header__title animate-fade-up animate-fade-up-delay-1`,children:[`Diyetisyen`,(0,j.jsx)(`br`,{}),(0,j.jsx)(`span`,{className:`ezgi-script-title`,children:`Ezgi Onaylı Küp`})]}),(0,j.jsx)(`p`,{className:`page-header__subtitle animate-fade-up animate-fade-up-delay-2`,children:`Yasaklarla değil, farkındalıkla değişim. Sürdürülebilir, dengeli ve besleyici bir yaşam tarzı.`})]}),(0,j.jsx)(`div`,{className:`page-header-leaf page-header-leaf--1`,"aria-hidden":`true`,children:`🌿`}),(0,j.jsx)(`div`,{className:`page-header-leaf page-header-leaf--2`,"aria-hidden":`true`,children:`🍋`})]}),(0,j.jsx)(`section`,{className:`section bg-white`,children:(0,j.jsxs)(`div`,{className:`container about-intro`,children:[(0,j.jsxs)(`div`,{className:`about-intro__img reveal`,children:[(0,j.jsx)(`img`,{src:Mi,alt:`Diyetisyen Ezgi Onaylı Küp — Klinik ortamında`,className:`about-intro__img-el`}),(0,j.jsx)(`div`,{className:`about-intro__img-deco`,"aria-hidden":`true`})]}),(0,j.jsxs)(`div`,{className:`about-intro__text reveal`,children:[(0,j.jsx)(`div`,{className:`section-eyebrow script-eyebrow`,children:`Merhaba!`}),(0,j.jsxs)(`h2`,{className:`section-title`,children:[`Ben `,(0,j.jsx)(`span`,{className:`ezgi-script-title`,children:`Ezgi Onaylı Küp.`})]}),(0,j.jsx)(`p`,{children:`Sağlıklı bir yaşamın, yasaklarla değil farkındalıkla mümkün olduğuna inanıyorum.`}),(0,j.jsx)(`p`,{style:{marginTop:`var(--space-3)`},children:`Sürdürülebilir, dengeli ve besleyici bir yaşam tarzı için buradayım.`}),(0,j.jsx)(`p`,{style:{marginTop:`var(--space-3)`},children:`Bilimsel yaklaşım, gerçekçi planlar ve sana özel destekle; sadece kilo vermeyi değil, kendinle barışık bir yaşamı hedefliyoruz.`}),(0,j.jsx)(`p`,{style:{marginTop:`var(--space-3)`},children:`Birlikte, sana iyi gelen seçimlerle güçlü bir dönüşüm yaratabiliriz.`}),(0,j.jsx)(`p`,{style:{marginTop:`var(--space-4)`},children:`Yalova'daki kliniğimde yüz yüze çalışıyorum; aynı zamanda Türkiye'nin her yerinden danışanlara online görüşme imkânı sunuyorum.`}),(0,j.jsxs)(`div`,{style:{display:`flex`,gap:`var(--space-3)`,marginTop:`var(--space-8)`,flexWrap:`wrap`},children:[(0,j.jsxs)(k,{to:`/danismanlik`,className:`btn btn-primary`,children:[`Danışmanlık Hizmetleri `,(0,j.jsx)(ei,{size:16})]}),(0,j.jsx)(k,{to:`/iletisim`,className:`btn btn-secondary`,children:`İletişime Geç`})]})]})]})}),(0,j.jsx)(`section`,{className:`section bg-cream-dark`,children:(0,j.jsxs)(`div`,{className:`container`,children:[(0,j.jsxs)(`div`,{className:`section-header section-header--center reveal`,children:[(0,j.jsx)(`div`,{className:`section-eyebrow`,children:`Çalışma Yaklaşımım`}),(0,j.jsxs)(`h2`,{className:`section-title`,children:[`Temel `,(0,j.jsx)(`em`,{children:`değerlerim`})]})]}),(0,j.jsx)(`div`,{className:`values-grid reveal`,children:Ui.map((e,t)=>(0,j.jsxs)(`div`,{className:`value-card`,children:[(0,j.jsx)(`div`,{className:`value-card__icon`,"aria-hidden":`true`,children:e.icon}),(0,j.jsx)(`h3`,{className:`value-card__title`,children:e.title}),(0,j.jsx)(`p`,{className:`value-card__desc`,children:e.desc})]},t))})]})}),(0,j.jsx)(`section`,{className:`section bg-white`,children:(0,j.jsx)(`div`,{className:`container`,children:(0,j.jsxs)(`div`,{className:`about-timeline-grid`,children:[(0,j.jsxs)(`div`,{className:`reveal`,children:[(0,j.jsx)(`div`,{className:`section-eyebrow`,children:`Eğitim`}),(0,j.jsxs)(`h2`,{className:`section-title`,style:{fontSize:`var(--text-3xl)`},children:[`Akademik `,(0,j.jsx)(`em`,{children:`geçmiş`})]}),(0,j.jsx)(`div`,{className:`timeline`,style:{marginTop:`var(--space-8)`},children:Vi.map((e,t)=>(0,j.jsxs)(`div`,{className:`timeline-item`,children:[(0,j.jsx)(`div`,{className:`timeline-dot`,children:(0,j.jsx)(li,{size:14})}),(0,j.jsxs)(`div`,{className:`timeline-content`,children:[(0,j.jsx)(`span`,{className:`timeline-year`,children:e.year}),(0,j.jsx)(`h3`,{className:`timeline-title`,children:e.title}),(0,j.jsx)(`p`,{className:`timeline-institution`,children:e.institution}),(0,j.jsx)(`p`,{className:`timeline-desc`,children:e.desc})]})]},t))})]}),(0,j.jsxs)(`div`,{className:`reveal`,children:[(0,j.jsx)(`div`,{className:`section-eyebrow`,children:`Deneyim`}),(0,j.jsxs)(`h2`,{className:`section-title`,style:{fontSize:`var(--text-3xl)`},children:[`Mesleki `,(0,j.jsx)(`em`,{children:`geçmiş`})]}),(0,j.jsx)(`div`,{className:`timeline`,style:{marginTop:`var(--space-8)`},children:Hi.map((e,t)=>(0,j.jsxs)(`div`,{className:`timeline-item`,children:[(0,j.jsx)(`div`,{className:`timeline-dot`,children:(0,j.jsx)(ri,{size:14})}),(0,j.jsxs)(`div`,{className:`timeline-content`,children:[(0,j.jsx)(`span`,{className:`timeline-year`,children:e.year}),(0,j.jsx)(`h3`,{className:`timeline-title`,children:e.title}),(0,j.jsx)(`p`,{className:`timeline-institution`,children:e.institution}),(0,j.jsx)(`p`,{className:`timeline-desc`,children:e.desc})]})]},t))})]})]})})}),(0,j.jsx)(`section`,{className:`section--sm bg-aqua-light`,children:(0,j.jsx)(`div`,{className:`container`,children:(0,j.jsx)(`div`,{className:`mevzuat-note reveal`,children:(0,j.jsxs)(`p`,{children:[(0,j.jsx)(`strong`,{children:`Önemli Bilgi:`}),` Bu web sitesi, Sağlık Hizmetlerinde Tanıtım ve Bilgilendirme Faaliyetleri Hakkında Yönetmelik kapsamında hazırlanmıştır. Sitedeki tüm içerikler genel bilgilendirme amaçlıdır ve bireysel tıbbi tavsiye niteliği taşımaz. Kişiye özel değerlendirme için lütfen uzman diyetisyen desteği alın.`]})})})}),(0,j.jsx)(`style`,{children:`
        .page-header {
          position: relative;
          overflow: hidden;
        }
      ...
      `})]})),Gi=[`Kapsamlı kişisel değerlendirme görüşmesi`,`Antropometrik ölçüm ve analiz`,`Kişiye özel beslenme planı hazırlanması`,`Yeme davranışı değerlendirmesi`,`Düzenli takip görüşmeleri`,`Süreç içi motivasyon ve destek`],Ki=[`Video platformu üzerinden görüşme`,`Kişiye özel beslenme planı`,`Dijital form ile ayrıntılı başvuru`,`E-posta ve mesajlaşma ile düzenli takip`,`Esnek randevu imkânı`,`Türkiye'nin her yerinden erişim`],qi=[{step:`01`,title:`İlk Başvuru`,desc:`İletişim formu veya WhatsApp üzerinden bilgi talebi oluşturursunuz.`},{step:`02`,title:`Ön Görüşme`,desc:`Kısa bir görüşme ile ihtiyaçlarınız ve sürece uygunluk değerlendirilir.`},{step:`03`,title:`Ayrıntılı Değerlendirme`,desc:`Beslenme alışkanlıklarınız, yaşam tarzınız ve hedefleriniz detaylıca ele alınır.`},{step:`04`,title:`Kişiye Özel Program`,desc:`Size özel beslenme planı ve yol haritası hazırlanır.`},{step:`05`,title:`Takip ve Destek`,desc:`Düzenli takip görüşmeleri ve ihtiyaç halinde güncelleme yapılır.`}],Ji=()=>((0,_.useEffect)(()=>{let e=document.querySelectorAll(`.reveal`),t=new IntersectionObserver(e=>e.forEach(e=>{e.isIntersecting&&(e.target.classList.add(`visible`),t.unobserve(e.target))}),{threshold:.1});return e.forEach(e=>t.observe(e)),()=>t.disconnect()},[]),(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(Ur,{children:[(0,j.jsx)(`title`,{children:`Danışmanlık | Diyetisyen Ezgi Onaylı Küp`}),(0,j.jsx)(`meta`,{name:`description`,content:`Yüz yüze Yalova kliniğinde ve Türkiye genelinde online beslenme danışmanlığı. Kişiye özel program ve düzenli takip.`})]}),(0,j.jsx)(`header`,{className:`page-header`,children:(0,j.jsxs)(`div`,{className:`container`,children:[(0,j.jsx)(`p`,{className:`page-header__eyebrow animate-fade-up`,children:`Danışmanlık`}),(0,j.jsxs)(`h1`,{className:`page-header__title animate-fade-up animate-fade-up-delay-1`,children:[`Yüz Yüze & `,(0,j.jsx)(`span`,{style:{color:`var(--color-aqua-dark)`,fontStyle:`italic`},children:`Online`}),(0,j.jsx)(`br`,{}),`Danışmanlık`]}),(0,j.jsx)(`p`,{className:`page-header__subtitle animate-fade-up animate-fade-up-delay-2`,children:`Yalova'da klinik ortamında ya da Türkiye'nin herhangi bir şehrinden — seçim sizin.`})]})}),(0,j.jsx)(`section`,{className:`section bg-white`,id:`yuz-yuze`,"aria-label":`Yüz yüze danışmanlık`,children:(0,j.jsxs)(`div`,{className:`container consulting-split`,children:[(0,j.jsx)(`div`,{className:`reveal`,children:(0,j.jsx)(`img`,{src:Mi,alt:`Yüz yüze danışmanlık — Yalova kliniği ortamı`,className:`consulting-img`})}),(0,j.jsxs)(`div`,{className:`reveal`,children:[(0,j.jsxs)(`span`,{className:`badge badge-sage`,children:[(0,j.jsx)(pi,{size:11}),` Yalova Kliniği`]}),(0,j.jsxs)(`h2`,{className:`section-title`,style:{marginTop:`var(--space-3)`},children:[`Yüz Yüze`,(0,j.jsx)(`br`,{}),(0,j.jsx)(`em`,{children:`Danışmanlık`})]}),(0,j.jsx)(`p`,{className:`consulting-desc`,children:`Yalova'daki kliniğimde gerçekleştirilen yüz yüze danışmanlık seanslarında, sizinle doğrudan, kişisel ve derinlemesine bir değerlendirme süreci yürütüyorum.`}),(0,j.jsx)(`ul`,{className:`feature-list`,children:Gi.map(e=>(0,j.jsxs)(`li`,{children:[(0,j.jsx)(ai,{size:16,color:`var(--color-sage)`}),e]},e))}),(0,j.jsx)(`div`,{style:{display:`flex`,gap:`var(--space-3)`,marginTop:`var(--space-8)`,flexWrap:`wrap`},children:(0,j.jsxs)(k,{to:`/iletisim`,className:`btn btn-sage btn--lg`,id:`face-consult-apply-btn`,children:[`Bilgi Al / Başvur `,(0,j.jsx)(ei,{size:16})]})}),(0,j.jsx)(`p`,{className:`consulting-note`,children:`* Bu sayfadaki bilgiler genel bilgilendirme amaçlıdır. Kişiye özel değerlendirme için lütfen iletişime geçin.`})]})]})}),(0,j.jsx)(`section`,{className:`section bg-cream-dark`,id:`online`,"aria-label":`Online danışmanlık`,children:(0,j.jsxs)(`div`,{className:`container consulting-split consulting-split--reverse`,children:[(0,j.jsxs)(`div`,{className:`reveal`,children:[(0,j.jsxs)(`span`,{className:`badge badge-aqua`,children:[(0,j.jsx)(gi,{size:11}),` Türkiye Geneli`]}),(0,j.jsxs)(`h2`,{className:`section-title`,style:{marginTop:`var(--space-3)`},children:[`Online`,(0,j.jsx)(`br`,{}),(0,j.jsx)(`em`,{children:`Danışmanlık`})]}),(0,j.jsx)(`p`,{className:`consulting-desc`,children:`Türkiye'nin herhangi bir şehrinde olsanız da, yoğun iş temponuzda kliniğe gidemesaniz de online görüşmeler aracılığıyla aynı kaliteli danışmanlık sürecini yaşayabilirsiniz.`}),(0,j.jsx)(`ul`,{className:`feature-list`,children:Ki.map(e=>(0,j.jsxs)(`li`,{children:[(0,j.jsx)(ai,{size:16,color:`var(--color-aqua)`}),e]},e))}),(0,j.jsxs)(`div`,{style:{display:`flex`,gap:`var(--space-3)`,marginTop:`var(--space-8)`,flexWrap:`wrap`},children:[(0,j.jsxs)(k,{to:`/online-danismanlik`,className:`btn btn-primary btn--lg`,id:`online-consult-detail-btn`,children:[`Detaylı Bilgi `,(0,j.jsx)(ei,{size:16})]}),(0,j.jsx)(k,{to:`/iletisim`,className:`btn btn-secondary btn--lg`,children:`Bilgi Al`})]})]}),(0,j.jsx)(`div`,{className:`reveal`,children:(0,j.jsx)(`img`,{src:Pi,alt:`Online danışmanlık — video görüşme`,className:`consulting-img`})})]})}),(0,j.jsx)(`section`,{className:`section bg-white`,"aria-label":`Danışmanlık süreci`,children:(0,j.jsxs)(`div`,{className:`container`,children:[(0,j.jsxs)(`div`,{className:`section-header section-header--center reveal`,children:[(0,j.jsx)(`div`,{className:`section-eyebrow`,children:`Süreç`}),(0,j.jsxs)(`h2`,{className:`section-title`,children:[`Nasıl `,(0,j.jsx)(`em`,{children:`ilerliyoruz?`})]}),(0,j.jsx)(`p`,{className:`section-subtitle`,children:`İlk temastan düzenli takibe kadar şeffaf ve net bir süreç.`})]}),(0,j.jsx)(`div`,{className:`process-steps reveal`,children:qi.map((e,t)=>(0,j.jsxs)(`div`,{className:`process-item`,children:[(0,j.jsx)(`div`,{className:`process-item__num`,children:e.step}),(0,j.jsxs)(`div`,{className:`process-item__content`,children:[(0,j.jsx)(`h3`,{className:`process-item__title`,children:e.title}),(0,j.jsx)(`p`,{className:`process-item__desc`,children:e.desc})]}),t<qi.length-1&&(0,j.jsx)(`div`,{className:`process-item__arrow`,"aria-hidden":`true`,children:(0,j.jsx)(ei,{size:16,color:`var(--color-aqua-light)`})})]},t))})]})}),(0,j.jsx)(`section`,{className:`section--sm bg-aqua-light`,"aria-label":`Bilgilendirme notu`,children:(0,j.jsx)(`div`,{className:`container`,children:(0,j.jsxs)(`div`,{className:`info-strip reveal`,children:[(0,j.jsxs)(`div`,{className:`info-strip__item`,children:[(0,j.jsx)(si,{size:20,color:`var(--color-aqua-dark)`}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`strong`,{children:`Randevu Süreci`}),(0,j.jsx)(`span`,{children:`İletişim formu veya WhatsApp üzerinden başvuru yapılır.`})]})]}),(0,j.jsxs)(`div`,{className:`info-strip__item`,children:[(0,j.jsx)(wi,{size:20,color:`var(--color-aqua-dark)`}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`strong`,{children:`Başvuru Niteliği`}),(0,j.jsx)(`span`,{children:`Başvurular randevu değil, bilgi talebi niteliğindedir.`})]})]}),(0,j.jsxs)(`div`,{className:`info-strip__item`,children:[(0,j.jsx)(pi,{size:20,color:`var(--color-aqua-dark)`}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`strong`,{children:`Yüz Yüze`}),(0,j.jsx)(`span`,{children:`Yalova kliniğinde gerçekleştirilir.`})]})]})]})})}),(0,j.jsx)(`style`,{children:`
        .consulting-split {
          display: grid;
      ...
      `})]})),Yi=[{num:`01`,title:`Başvuru Formu`,desc:`Aşağıdaki formu doldurarak bilgi talebinde bulunun. İhtiyaçlarınızı ve beklentilerinizi kısaca paylaşın.`},{num:`02`,title:`İlk İletişim`,desc:`En kısa sürede sizinle iletişime geçilir ve ön görüşme için uygun zaman belirlenir.`},{num:`03`,title:`Online Görüşme`,desc:`Video platformu üzerinden gerçekleştirilecek görüşmede ihtiyaçlarınız ayrıntılı ele alınır.`},{num:`04`,title:`Kişiye Özel Program`,desc:`Değerlendirme sonrasında yaşam tarzınıza, ihtiyaçlarınıza ve hedeflerinize özel bir beslenme planı hazırlanır.`},{num:`05`,title:`Düzenli Takip`,desc:`Belirlenen aralıklarla online takip görüşmeleri yapılır, plan güncellenir.`}],Xi=[`Video platformu üzerinden detaylı görüşme`,`Kişiye özel beslenme planı`,`Yeme davranışı değerlendirmesi`,`Dijital form ile beslenme geçmişi analizi`,`Belirlenen aralıklarda takip görüşmeleri`,`Süreç içi mesajlaşma desteği`,`Plan güncellemeleri`],Zi=()=>{let[e,t]=(0,_.useState)({name:``,email:``,phone:``,city:``,message:``}),[n,r]=(0,_.useState)(!1);return(0,_.useEffect)(()=>{let e=document.querySelectorAll(`.reveal`),t=new IntersectionObserver(e=>e.forEach(e=>{e.isIntersecting&&(e.target.classList.add(`visible`),t.unobserve(e.target))}),{threshold:.1});return e.forEach(e=>t.observe(e)),()=>t.disconnect()},[]),(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(Ur,{children:[(0,j.jsx)(`title`,{children:`Online Danışmanlık | Diyetisyen Ezgi Onaylı Küp`}),(0,j.jsx)(`meta`,{name:`description`,content:`Türkiye'nin her yerinden online beslenme danışmanlığı. Video görüşme, kişiye özel program ve düzenli takip. Bilgi al ve başvur.`})]}),(0,j.jsx)(`header`,{className:`page-header`,children:(0,j.jsxs)(`div`,{className:`container`,children:[(0,j.jsx)(`p`,{className:`page-header__eyebrow animate-fade-up`,children:`Online Danışmanlık`}),(0,j.jsxs)(`h1`,{className:`page-header__title animate-fade-up animate-fade-up-delay-1`,children:[`Türkiye'nin Her Yerinden`,(0,j.jsx)(`br`,{}),(0,j.jsx)(`span`,{style:{color:`var(--color-aqua-dark)`,fontStyle:`italic`},children:`Online Danışmanlık`})]}),(0,j.jsx)(`p`,{className:`page-header__subtitle animate-fade-up animate-fade-up-delay-2`,children:`Bulunduğunuz şehirden bağımsız olarak, aynı kaliteli ve kişiselleştirilmiş beslenme danışmanlığı hizmetine erişebilirsiniz.`})]})}),(0,j.jsx)(`section`,{className:`section bg-white`,"aria-label":`Online danışmanlık nasıl çalışır`,children:(0,j.jsxs)(`div`,{className:`container`,children:[(0,j.jsxs)(`div`,{className:`section-header section-header--center reveal`,children:[(0,j.jsx)(`div`,{className:`section-eyebrow`,children:`Süreç`}),(0,j.jsxs)(`h2`,{className:`section-title`,children:[`Nasıl `,(0,j.jsx)(`em`,{children:`çalışır?`})]})]}),(0,j.jsx)(`div`,{className:`online-steps reveal`,children:Yi.map(e=>(0,j.jsxs)(`div`,{className:`online-step`,children:[(0,j.jsx)(`div`,{className:`online-step__num`,children:e.num}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`h3`,{className:`online-step__title`,children:e.title}),(0,j.jsx)(`p`,{className:`online-step__desc`,children:e.desc})]})]},e.num))})]})}),(0,j.jsx)(`section`,{className:`section bg-cream-dark`,"aria-label":`Neler dahil`,children:(0,j.jsxs)(`div`,{className:`container online-included-grid`,children:[(0,j.jsx)(`div`,{className:`reveal`,children:(0,j.jsx)(`img`,{src:Pi,alt:`Online beslenme danışmanlığı — video görüşme`,style:{width:`100%`,borderRadius:`var(--radius-xl)`,boxShadow:`var(--shadow-xl)`,objectFit:`cover`,aspectRatio:`4/3`}})}),(0,j.jsxs)(`div`,{className:`reveal`,children:[(0,j.jsx)(`div`,{className:`section-eyebrow`,children:`Kapsam`}),(0,j.jsxs)(`h2`,{className:`section-title`,children:[`Neler `,(0,j.jsx)(`em`,{children:`dahil?`})]}),(0,j.jsx)(`ul`,{className:`online-included-list`,children:Xi.map(e=>(0,j.jsxs)(`li`,{children:[(0,j.jsx)(ai,{size:18,color:`var(--color-aqua)`}),(0,j.jsx)(`span`,{children:e})]},e))}),(0,j.jsxs)(`div`,{className:`online-note`,children:[(0,j.jsx)(si,{size:16}),(0,j.jsxs)(`p`,{children:[(0,j.jsx)(`strong`,{children:`Önemli Not:`}),` Online danışmanlık sürecinin içeriği, seans sıklığı ve kapsamı bireysel ihtiyaçlara göre şekillendirilir. Detaylı bilgi için lütfen başvuru formu aracılığıyla iletişime geçin.`]})]})]})]})}),(0,j.jsx)(`section`,{className:`section bg-white`,"aria-label":`Başvuru formu`,id:`basvuru`,children:(0,j.jsx)(`div`,{className:`container`,children:(0,j.jsxs)(`div`,{className:`online-form-wrapper`,children:[(0,j.jsxs)(`div`,{className:`section-header reveal`,children:[(0,j.jsx)(`div`,{className:`section-eyebrow`,children:`Bilgi Talebi`}),(0,j.jsxs)(`h2`,{className:`section-title`,children:[`Başvuru `,(0,j.jsx)(`em`,{children:`Formu`})]}),(0,j.jsx)(`p`,{className:`section-subtitle`,children:`Bu form bilgi talebi niteliğindedir; randevu oluşturmaz. En kısa sürede sizinle iletişime geçilir.`})]}),n?(0,j.jsxs)(`div`,{className:`form-success reveal`,children:[(0,j.jsx)(`div`,{className:`form-success__icon`,children:`✓`}),(0,j.jsx)(`h3`,{children:`Başvurunuz Alındı!`}),(0,j.jsx)(`p`,{children:`En kısa sürede sizinle iletişime geçeceğim. Teşekkürler!`})]}):(0,j.jsxs)(`form`,{onSubmit:e=>{e.preventDefault(),r(!0)},className:`online-form reveal`,noValidate:!0,children:[(0,j.jsxs)(`div`,{className:`grid-2`,children:[(0,j.jsxs)(`div`,{className:`form-group`,children:[(0,j.jsx)(`label`,{htmlFor:`online-name`,className:`form-label`,children:`Ad Soyad *`}),(0,j.jsx)(`input`,{id:`online-name`,type:`text`,className:`form-input`,placeholder:`Adınız Soyadınız`,value:e.name,onChange:n=>t({...e,name:n.target.value}),required:!0})]}),(0,j.jsxs)(`div`,{className:`form-group`,children:[(0,j.jsx)(`label`,{htmlFor:`online-email`,className:`form-label`,children:`E-posta *`}),(0,j.jsx)(`input`,{id:`online-email`,type:`email`,className:`form-input`,placeholder:`ornek@eposta.com`,value:e.email,onChange:n=>t({...e,email:n.target.value}),required:!0})]}),(0,j.jsxs)(`div`,{className:`form-group`,children:[(0,j.jsx)(`label`,{htmlFor:`online-phone`,className:`form-label`,children:`Telefon`}),(0,j.jsx)(`input`,{id:`online-phone`,type:`tel`,className:`form-input`,placeholder:`+90 5XX XXX XX XX`,value:e.phone,onChange:n=>t({...e,phone:n.target.value})})]}),(0,j.jsxs)(`div`,{className:`form-group`,children:[(0,j.jsx)(`label`,{htmlFor:`online-city`,className:`form-label`,children:`Şehir`}),(0,j.jsx)(`input`,{id:`online-city`,type:`text`,className:`form-input`,placeholder:`İstanbul, Ankara…`,value:e.city,onChange:n=>t({...e,city:n.target.value})})]})]}),(0,j.jsxs)(`div`,{className:`form-group`,style:{marginTop:`var(--space-4)`},children:[(0,j.jsx)(`label`,{htmlFor:`online-message`,className:`form-label`,children:`Mesajınız / Beklentileriniz`}),(0,j.jsx)(`textarea`,{id:`online-message`,className:`form-textarea`,placeholder:`Kendinizi kısaca tanıtın ve online danışmanlık hakkında sorularınızı veya beklentilerinizi paylaşın...`,value:e.message,onChange:n=>t({...e,message:n.target.value}),rows:5})]}),(0,j.jsx)(`div`,{className:`form-disclaimer`,children:(0,j.jsxs)(`p`,{children:[`Kişisel verileriniz yalnızca iletişim amacıyla işlenecek ve üçüncü taraflarla paylaşılmayacaktır. Detaylı bilgi için`,` `,(0,j.jsx)(k,{to:`/kvkk`,children:`KVKK Aydınlatma Metni`}),`'ni inceleyebilirsiniz.`]})}),(0,j.jsxs)(`button`,{type:`submit`,className:`btn btn-primary btn--lg form-submit`,id:`online-form-submit`,children:[(0,j.jsx)(yi,{size:16}),`Bilgi Talebi Gönder`]})]}),(0,j.jsx)(`div`,{className:`or-divider reveal`,children:(0,j.jsx)(`span`,{children:`veya doğrudan iletişime geçin`})}),(0,j.jsxs)(`div`,{className:`contact-alternatives reveal`,children:[(0,j.jsxs)(`a`,{href:`https://wa.me/905542090903`,target:`_blank`,rel:`noopener noreferrer`,className:`alt-contact`,id:`online-whatsapp-btn`,children:[(0,j.jsx)(hi,{size:20}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`strong`,{children:`WhatsApp`}),(0,j.jsx)(`span`,{children:`Hızlı yanıt için`})]}),(0,j.jsx)(ei,{size:14})]}),(0,j.jsxs)(`a`,{href:`mailto:dytezgionayli@gmail.com`,className:`alt-contact`,id:`online-email-btn`,children:[(0,j.jsx)(fi,{size:20}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`strong`,{children:`E-posta`}),(0,j.jsx)(`span`,{children:`dytezgionayli@gmail.com`})]}),(0,j.jsx)(ei,{size:14})]})]})]})})}),(0,j.jsx)(`style`,{children:`
        .online-steps {
          max-width: 720px;
          margin: 0 auto;
          display: flex;
      ...
      `})]})},Qi=[{id:`1`,title:`Akdeniz Tipi Beslenme Rehberi`,description:`Akdeniz mutfağından ilham alan, günlük hayata kolayca uyarlanabilir kapsamlı bir beslenme rehberi. Haftalık örnek menüler ve pratik öneriler içerir.`,category:`rehber`,status:`coming-soon`,tag:`Yakında`},{id:`2`,title:`Yeme Davranışını Anlamak`,description:`Duygusal yeme, otomatik yeme davranışları ve zihin-beden bağlantısı üzerine kapsamlı bir e-kitap. Öz farkındalık egzersizleri ve pratik araçlar içerir.`,category:`e-kitap`,status:`coming-soon`,tag:`Yakında`},{id:`3`,title:`Sağlıklı Tarifler Koleksiyonu`,description:`Beslenme değeri hesaplanmış, hazırlanması kolay ve lezzetli 50 tarif. Mevsimsel malzemeler ve pratik mutfak önerileri.`,category:`e-kitap`,status:`coming-soon`,tag:`Yakında`},{id:`4`,title:`Beslenme Temelleri Video Serisi`,description:`Makro ve mikro besin öğelerinden, etiket okumaya kadar beslenme biliminin temellerini ele alan video eğitim serisi.`,category:`video`,status:`coming-soon`,tag:`Yakında`},{id:`5`,title:`Online Beslenme Semineri`,description:`Sürdürülebilir kilo yönetimi üzerine interaktif online seminer. Soru-cevap bölümü dahil.`,category:`seminer`,status:`coming-soon`,tag:`Yakında`},{id:`6`,title:`Kilo Yönetimi Çalışma Kitabı`,description:`Kilo yönetimi sürecinizi kendi hızınızda takip etmenizi sağlayan, bilimsel temelli bir çalışma kitabı.`,category:`rehber`,status:`coming-soon`,tag:`Yakında`}],$i={rehber:`Rehber`,"e-kitap":`E-Kitap`,video:`Video Eğitim`,seminer:`Online Seminer`,atölye:`Atölye`},ea={rehber:(0,j.jsx)(ni,{size:18}),"e-kitap":(0,j.jsx)(ui,{size:18}),video:(0,j.jsx)(Ti,{size:18}),seminer:(0,j.jsx)(wi,{size:18}),atölye:(0,j.jsx)(wi,{size:18})},ta={rehber:`badge-sage`,"e-kitap":`badge-aqua`,video:`badge-lemon`,seminer:`badge-coming-soon`,atölye:`badge-sage`},na=()=>{let[e,t]=(0,_.useState)(``),[n,r]=(0,_.useState)(!1);return(0,_.useEffect)(()=>{let e=document.querySelectorAll(`.reveal`),t=new IntersectionObserver(e=>e.forEach(e=>{e.isIntersecting&&(e.target.classList.add(`visible`),t.unobserve(e.target))}),{threshold:.1});return e.forEach(e=>t.observe(e)),()=>t.disconnect()},[]),(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(Ur,{children:[(0,j.jsx)(`title`,{children:`Ezgi Onaylı Küp Akademi | Diyetisyen Ezgi Onaylı Küp`}),(0,j.jsx)(`meta`,{name:`description`,content:`Ezgi Onaylı Küp Akademi — Beslenme eğitimleri, e-kitaplar, video rehberler ve grup çalışmaları. Genel bilgilendirme amaçlı dijital içerikler.`})]}),(0,j.jsxs)(`header`,{className:`academy-header`,children:[(0,j.jsx)(`div`,{className:`container`,children:(0,j.jsxs)(`div`,{className:`academy-header__content animate-fade-up`,children:[(0,j.jsx)(`span`,{className:`badge badge-lemon`,children:`Dijital İçerikler`}),(0,j.jsxs)(`h1`,{className:`academy-header__title`,children:[`Ezgi Onaylı Küp `,(0,j.jsx)(`em`,{children:`Akademi`})]}),(0,j.jsx)(`p`,{className:`academy-header__subtitle`,children:`Kişiye özel danışmanlık hizmetinden bağımsız olarak, genel beslenme eğitimi ve bilgilendirme amaçlı dijital içerikler.`})]})}),(0,j.jsx)(`div`,{className:`academy-header-deco`,"aria-hidden":`true`,children:`📚`}),(0,j.jsx)(`div`,{className:`academy-header-deco academy-header-deco--2`,"aria-hidden":`true`,children:`🌿`})]}),(0,j.jsx)(`section`,{className:`section--sm bg-white`,"aria-label":`Akademi hakkında bilgilendirme`,children:(0,j.jsx)(`div`,{className:`container`,children:(0,j.jsxs)(`div`,{className:`academy-note reveal`,children:[(0,j.jsx)(`div`,{className:`academy-note__icon`,children:`ℹ️`}),(0,j.jsx)(`div`,{children:(0,j.jsxs)(`p`,{children:[(0,j.jsx)(`strong`,{children:`Akademi İçerikleri Hakkında:`}),` Bu bölümdeki dijital içerikler (e-kitaplar, rehberler, video eğitimler) `,(0,j.jsx)(`em`,{children:`genel eğitim ve bilgilendirme amacıyla`}),`hazırlanmaktadır. Kişiye özel sağlık danışmanlığı niteliği taşımaz ve bireysel tıbbi tavsiye yerine geçmez. Kişiselleştirilmiş beslenme danışmanlığı için lütfen "Danışmanlık" bölümüne göz atın.`]})})]})})}),(0,j.jsx)(`section`,{className:`section bg-cream-dark`,"aria-label":`Dijital içerikler kataloğu`,children:(0,j.jsxs)(`div`,{className:`container`,children:[(0,j.jsxs)(`div`,{className:`section-header section-header--center reveal`,children:[(0,j.jsx)(`div`,{className:`section-eyebrow`,children:`İçerik Kataloğu`}),(0,j.jsxs)(`h2`,{className:`section-title`,children:[`Yakında burada `,(0,j.jsx)(`em`,{children:`olacaklar`})]}),(0,j.jsx)(`p`,{className:`section-subtitle`,children:`Şu anda hazırlık aşamasındaki içerikler. E-posta listesine katılarak yayınlandıklarında haberdar olun.`})]}),(0,j.jsx)(`div`,{className:`academy-grid reveal`,children:Qi.map(e=>(0,j.jsxs)(`article`,{className:`academy-card`,children:[(0,j.jsxs)(`div`,{className:`academy-card__header`,children:[(0,j.jsx)(`div`,{className:`academy-card__icon`,"aria-hidden":`true`,children:ea[e.category]}),(0,j.jsxs)(`div`,{style:{display:`flex`,gap:`var(--space-2)`,flexWrap:`wrap`},children:[(0,j.jsx)(`span`,{className:`badge ${ta[e.category]}`,children:$i[e.category]}),e.status===`coming-soon`&&(0,j.jsx)(`span`,{className:`badge badge-coming-soon`,children:`Yakında`})]})]}),(0,j.jsx)(`h3`,{className:`academy-card__title`,children:e.title}),(0,j.jsx)(`p`,{className:`academy-card__desc`,children:e.description}),(0,j.jsx)(`div`,{className:`academy-card__footer`,children:(0,j.jsxs)(`button`,{className:`btn btn-secondary btn--sm academy-card__notify`,disabled:!0,children:[(0,j.jsx)(ti,{size:13}),`Haberdar Ol`]})})]},e.id))})]})}),(0,j.jsx)(`section`,{className:`section bg-white`,"aria-label":`Neler geliyor`,children:(0,j.jsxs)(`div`,{className:`container`,children:[(0,j.jsxs)(`div`,{className:`section-header section-header--center reveal`,children:[(0,j.jsx)(`div`,{className:`section-eyebrow`,children:`Kategoriler`}),(0,j.jsxs)(`h2`,{className:`section-title`,children:[`Neler `,(0,j.jsx)(`em`,{children:`planlıyorum?`})]})]}),(0,j.jsx)(`div`,{className:`coming-categories reveal`,children:[{icon:(0,j.jsx)(ni,{size:24}),label:`E-Kitaplar`,desc:`Beslenme, yeme davranışı ve sağlıklı yaşam üzerine dijital kitaplar.`},{icon:(0,j.jsx)(ui,{size:24}),label:`Beslenme Rehberleri`,desc:`Belirli konulara odaklanan, uygulamalı rehber kitapçıklar.`},{icon:(0,j.jsx)(Ti,{size:24}),label:`Video Eğitimler`,desc:`Beslenme biliminin temellerini anlatan video ders serileri.`},{icon:(0,j.jsx)(wi,{size:24}),label:`Grup Çalışmaları`,desc:`Online seminerler, atölyeler ve grup destek programları.`}].map((e,t)=>(0,j.jsxs)(`div`,{className:`coming-cat`,children:[(0,j.jsx)(`div`,{className:`coming-cat__icon`,"aria-hidden":`true`,children:e.icon}),(0,j.jsx)(`h3`,{className:`coming-cat__label`,children:e.label}),(0,j.jsx)(`p`,{className:`coming-cat__desc`,children:e.desc})]},t))})]})}),(0,j.jsx)(`section`,{className:`section academy-subscribe`,"aria-label":`E-posta listesi`,children:(0,j.jsx)(`div`,{className:`container`,children:(0,j.jsxs)(`div`,{className:`academy-subscribe__inner reveal`,children:[(0,j.jsx)(ti,{size:32,color:`var(--color-lemon)`}),(0,j.jsxs)(`h2`,{className:`academy-subscribe__title`,children:[`İçerikler yayınlandığında`,(0,j.jsx)(`br`,{}),(0,j.jsx)(`em`,{children:`ilk sen haberdar ol.`})]}),(0,j.jsx)(`p`,{className:`academy-subscribe__desc`,children:`E-posta listesine katıl, yeni içerikler ve eğitimler hakkında bildirim al.`}),n?(0,j.jsxs)(`div`,{className:`subscribe-success`,children:[(0,j.jsx)(`span`,{children:`✓`}),` Teşekkürler! Liste kaydınız alındı.`]}):(0,j.jsxs)(`form`,{onSubmit:e=>{e.preventDefault(),r(!0)},className:`subscribe-form`,children:[(0,j.jsx)(`input`,{type:`email`,className:`form-input subscribe-input`,placeholder:`E-posta adresiniz`,value:e,onChange:e=>t(e.target.value),required:!0,id:`academy-email-input`,"aria-label":`E-posta adresi`}),(0,j.jsxs)(`button`,{type:`submit`,className:`btn btn-primary`,id:`academy-subscribe-btn`,children:[`Abone Ol `,(0,j.jsx)(ei,{size:16})]})]}),(0,j.jsx)(`p`,{className:`subscribe-note`,children:`Spam göndermiyoruz. İstediğiniz zaman aboneliği iptal edebilirsiniz.`})]})})}),(0,j.jsx)(`style`,{children:`
        .academy-header {
      ...
      `})]})},ra=()=>{let[e,t]=(0,_.useState)(`hepsi`),[n,r]=(0,_.useState)(``),i=M.filter(t=>{let r=e===`hepsi`||t.category===e,i=n===``||t.title.toLowerCase().includes(n.toLowerCase())||t.excerpt.toLowerCase().includes(n.toLowerCase());return r&&i});return(0,_.useEffect)(()=>{let e=document.querySelectorAll(`.reveal`),t=new IntersectionObserver(e=>e.forEach(e=>{e.isIntersecting&&(e.target.classList.add(`visible`),t.unobserve(e.target))}),{threshold:.1});return e.forEach(e=>t.observe(e)),()=>t.disconnect()},[]),(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(Ur,{children:[(0,j.jsx)(`title`,{children:`Beslenme Rehberi | Diyetisyen Ezgi Onaylı Küp`}),(0,j.jsx)(`meta`,{name:`description`,content:`Bilimsel temelli beslenme yazıları, rehberler ve videolar. Akdeniz tipi beslenme, yeme davranışı, sürdürülebilir kilo yönetimi ve daha fazlası.`})]}),(0,j.jsx)(`header`,{className:`page-header`,children:(0,j.jsxs)(`div`,{className:`container`,children:[(0,j.jsx)(`p`,{className:`page-header__eyebrow animate-fade-up`,children:`Beslenme Rehberi`}),(0,j.jsxs)(`h1`,{className:`page-header__title animate-fade-up animate-fade-up-delay-1`,children:[`Bilimsel temelli`,(0,j.jsx)(`br`,{}),(0,j.jsx)(`span`,{style:{color:`var(--color-aqua-dark)`,fontStyle:`italic`},children:`beslenme içerikleri`})]}),(0,j.jsx)(`p`,{className:`page-header__subtitle animate-fade-up animate-fade-up-delay-2`,children:`Genel bilgilendirme amaçlı yazılar, beslenme rehberleri ve içerikler. Tüm içerikler güncel bilimsel kaynaklara dayanmaktadır.`})]})}),(0,j.jsx)(`section`,{className:`section--sm bg-white sticky-filter`,"aria-label":`Filtreleme`,children:(0,j.jsx)(`div`,{className:`container`,children:(0,j.jsxs)(`div`,{className:`guide-toolbar reveal`,children:[(0,j.jsx)(`div`,{className:`guide-filter-tabs`,role:`tablist`,"aria-label":`İçerik kategorileri`,children:[`hepsi`,`yazı`,`video`,`rehber`].map(n=>(0,j.jsx)(`button`,{role:`tab`,"aria-selected":e===n,className:`filter-tab${e===n?` filter-tab--active`:``}`,onClick:()=>t(n),id:`tab-${n}`,children:n.charAt(0).toUpperCase()+n.slice(1)},n))}),(0,j.jsxs)(`div`,{className:`guide-search`,children:[(0,j.jsx)(vi,{size:16,"aria-hidden":`true`}),(0,j.jsx)(`input`,{type:`search`,className:`form-input guide-search-input`,placeholder:`İçeriklerde ara…`,value:n,onChange:e=>r(e.target.value),"aria-label":`İçeriklerde arama`,id:`blog-search`})]})]})})}),(0,j.jsxs)(`section`,{className:`section bg-cream-dark`,"aria-label":`İçerik listesi`,children:[(0,j.jsx)(`div`,{className:`container`,children:i.length===0?(0,j.jsx)(`div`,{className:`no-results`,children:(0,j.jsx)(`p`,{children:`Arama kriterlerine uygun içerik bulunamadı.`})}):(0,j.jsx)(`div`,{className:`guide-grid`,children:i.map((e,t)=>(0,j.jsxs)(`article`,{className:`guide-card reveal`,style:{animationDelay:`${t*.06}s`},children:[(0,j.jsx)(k,{to:`/beslenme-rehberi/${e.slug}`,className:`guide-card__img-link`,"aria-label":e.title,children:(0,j.jsxs)(`div`,{className:`guide-card__img`,children:[(0,j.jsx)(`img`,{src:e.image,alt:e.imageAlt}),(0,j.jsx)(`span`,{className:`guide-card__cat-badge`,children:e.category})]})}),(0,j.jsxs)(`div`,{className:`guide-card__body`,children:[(0,j.jsx)(`h2`,{className:`guide-card__title`,children:(0,j.jsx)(k,{to:`/beslenme-rehberi/${e.slug}`,children:e.title})}),(0,j.jsxs)(`p`,{className:`guide-card__excerpt`,children:[e.excerpt.substring(0,140),`…`]}),(0,j.jsxs)(`div`,{className:`guide-card__meta`,children:[(0,j.jsxs)(`span`,{className:`guide-card__time`,children:[(0,j.jsx)(si,{size:13}),e.readTime,` dk okuma`]}),(0,j.jsxs)(k,{to:`/beslenme-rehberi/${e.slug}`,className:`guide-card__cta`,"aria-label":`${e.title} yazısını oku`,children:[`Devamını Oku `,(0,j.jsx)(ei,{size:13})]})]})]})]},e.id))})}),(0,j.jsx)(`div`,{className:`container`,style:{marginTop:`var(--space-12)`},children:(0,j.jsx)(`div`,{className:`guide-disclaimer reveal`,children:(0,j.jsxs)(`p`,{children:[(0,j.jsx)(`strong`,{children:`Önemli:`}),` Bu sayfadaki içerikler genel bilgilendirme ve eğitim amaçlıdır; bireysel tıbbi tavsiye veya tanı niteliği taşımaz. Kişiye özel beslenme danışmanlığı için lütfen bir sağlık profesyoneline başvurun.`]})})})]}),(0,j.jsx)(`style`,{children:`
        .guide-toolbar {
          display: flex;
          align-items: center;
          justify-content: space-between;
      ...
      `})]})},ia=()=>{let{slug:e}=bt(),t=M.find(t=>t.slug===e),n=M.filter(t=>t.slug!==e).slice(0,3);return(0,_.useEffect)(()=>{window.scrollTo(0,0)},[e]),t?(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(Ur,{children:[(0,j.jsxs)(`title`,{children:[t.title,` | Diyetisyen Ezgi Onaylı Küp`]}),(0,j.jsx)(`meta`,{name:`description`,content:t.excerpt.substring(0,155)}),(0,j.jsx)(`meta`,{property:`og:title`,content:t.title}),(0,j.jsx)(`meta`,{property:`og:description`,content:t.excerpt.substring(0,155)}),(0,j.jsx)(`meta`,{property:`og:type`,content:`article`}),(0,j.jsx)(`script`,{type:`application/ld+json`,children:JSON.stringify({"@context":`https://schema.org`,"@type":`Article`,headline:t.title,description:t.excerpt.substring(0,155),author:{"@type":`Person`,name:`Ezgi Onaylı Küp`},publisher:{"@type":`Organization`,name:`Diyetisyen Ezgi Onaylı Küp`},datePublished:t.publishedAt,image:`https://ezgionaylikup.com/blog-mediterranean.png`})})]}),(0,j.jsx)(`div`,{className:`post-back-bar`,children:(0,j.jsx)(`div`,{className:`container`,children:(0,j.jsxs)(k,{to:`/beslenme-rehberi`,className:`post-back-link`,children:[(0,j.jsx)($r,{size:16}),` Beslenme Rehberi`]})})}),(0,j.jsxs)(`div`,{className:`post-hero`,children:[(0,j.jsx)(`img`,{src:t.image,alt:t.imageAlt,className:`post-hero-img`}),(0,j.jsx)(`div`,{className:`post-hero-overlay`,"aria-hidden":`true`})]}),(0,j.jsxs)(`div`,{className:`container post-layout`,children:[(0,j.jsxs)(`article`,{className:`post-article`,itemScope:!0,itemType:`https://schema.org/Article`,children:[(0,j.jsxs)(`header`,{className:`post-header`,children:[(0,j.jsxs)(`div`,{className:`post-meta`,children:[(0,j.jsx)(`span`,{className:`badge badge-sage`,children:t.category}),(0,j.jsxs)(`span`,{className:`post-read-time`,children:[(0,j.jsx)(si,{size:13}),` `,t.readTime,` dk okuma`]}),(0,j.jsx)(`time`,{dateTime:t.publishedAt,itemProp:`datePublished`,className:`post-date`,children:new Date(t.publishedAt).toLocaleDateString(`tr-TR`,{day:`numeric`,month:`long`,year:`numeric`})})]}),(0,j.jsx)(`h1`,{className:`post-title`,itemProp:`headline`,children:t.title}),(0,j.jsx)(`p`,{className:`post-excerpt`,itemProp:`description`,children:t.excerpt}),(0,j.jsxs)(`div`,{className:`post-author`,itemProp:`author`,itemScope:!0,itemType:`https://schema.org/Person`,children:[(0,j.jsx)(`div`,{className:`post-author__avatar`,children:`EÖ`}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`span`,{itemProp:`name`,className:`post-author__name`,children:`Diyetisyen Ezgi Onaylı Küp`}),(0,j.jsx)(`span`,{className:`post-author__role`,children:`Diyetisyen`})]})]})]}),(0,j.jsx)(`div`,{className:`post-content`,itemProp:`articleBody`,children:(e=>e.trim().split(`

`).map((e,t)=>{if(e.startsWith(`## `))return(0,j.jsx)(`h2`,{className:`post-h2`,children:e.replace(`## `,``)},t);if(e.startsWith(`- `)){let n=e.split(`
`).filter(e=>e.startsWith(`- `));return(0,j.jsx)(`ul`,{className:`post-list`,children:n.map((e,t)=>(0,j.jsx)(`li`,{children:e.replace(`- `,``).replace(/\*\*(.*?)\*\*/g,`$1`)},t))},t)}return e.startsWith(`*`)&&e.endsWith(`*`)?(0,j.jsx)(`p`,{className:`post-disclaimer`,children:e.replace(/\*/g,``)},t):(0,j.jsx)(`p`,{className:`post-p`,children:e},t)}))(t.content)}),(0,j.jsxs)(`div`,{className:`post-content-disclaimer`,children:[(0,j.jsx)(`strong`,{children:`⚠️ Önemli Bilgilendirme:`}),` Bu içerik yalnızca genel bilgilendirme amaçlıdır ve bireysel tıbbi tavsiye, tanı veya tedavi yerine geçmez. Sağlığınızla ilgili kararlar için lütfen bir sağlık profesyoneline danışın.`]})]}),(0,j.jsx)(`aside`,{className:`post-sidebar`,"aria-label":`Diğer içerikler`,children:(0,j.jsxs)(`div`,{className:`sidebar-sticky`,children:[(0,j.jsxs)(`div`,{className:`sidebar-card`,children:[(0,j.jsx)(`h3`,{className:`sidebar-title`,children:`Diğer Yazılar`}),(0,j.jsx)(`div`,{className:`sidebar-posts`,children:n.map(e=>(0,j.jsxs)(k,{to:`/beslenme-rehberi/${e.slug}`,className:`sidebar-post`,children:[(0,j.jsx)(`span`,{className:`sidebar-post__title`,children:e.title}),(0,j.jsxs)(`span`,{className:`sidebar-post__time`,children:[(0,j.jsx)(si,{size:11}),` `,e.readTime,` dk`]})]},e.id))}),(0,j.jsxs)(k,{to:`/beslenme-rehberi`,className:`btn btn-ghost btn--sm sidebar-all`,children:[`Tüm Yazılar `,(0,j.jsx)(ei,{size:13})]})]}),(0,j.jsxs)(`div`,{className:`sidebar-card sidebar-cta`,children:[(0,j.jsx)(`h3`,{children:`Kişisel danışmanlık almak ister misiniz?`}),(0,j.jsx)(`p`,{children:`Bu içerik genel bilgilendirme amaçlıdır. Kişiye özel destek için benimle iletişime geçebilirsiniz.`}),(0,j.jsx)(k,{to:`/iletisim`,className:`btn btn-primary btn--sm`,children:`Bilgi Al`})]})]})})]}),(0,j.jsx)(`style`,{children:`
        .post-back-bar {
      ...
      `})]}):(0,j.jsx)(Ht,{to:`/beslenme-rehberi`,replace:!0})},aa=()=>{let[e,t]=(0,_.useState)({name:``,email:``,phone:``,type:``,message:``}),[n,r]=(0,_.useState)(!1);return(0,_.useEffect)(()=>{let e=document.querySelectorAll(`.reveal`),t=new IntersectionObserver(e=>e.forEach(e=>{e.isIntersecting&&(e.target.classList.add(`visible`),t.unobserve(e.target))}),{threshold:.1});return e.forEach(e=>t.observe(e)),()=>t.disconnect()},[]),(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(Ur,{children:[(0,j.jsx)(`title`,{children:`İletişim | Diyetisyen Ezgi Onaylı Küp`}),(0,j.jsx)(`meta`,{name:`description`,content:`Diyetisyen Ezgi Onaylı Küp ile iletişime geçin. Yüz yüze Yalova kliniği veya online danışmanlık hakkında bilgi talep edin.`}),(0,j.jsx)(`script`,{type:`application/ld+json`,children:JSON.stringify({"@context":`https://schema.org`,"@type":`MedicalBusiness`,name:`Diyetisyen Ezgi Onaylı Küp`,description:`Beslenme danışmanlığı — yüz yüze ve online`,address:{"@type":`PostalAddress`,streetAddress:`Bağlarbaşı Mah. Başçılar Sok. No:1 Daire:9 (Life 226)`,addressLocality:`Yalova`,addressCountry:`TR`},telephone:`+905542090903`,email:`dytezgionayli@gmail.com`,url:`https://ezgionaylikup.com`})})]}),(0,j.jsx)(`header`,{className:`page-header`,children:(0,j.jsxs)(`div`,{className:`container`,children:[(0,j.jsx)(`span`,{className:`badge badge-olive mb-3`,children:`İletişim & Randevu`}),(0,j.jsx)(`h1`,{className:`page-header__title`,children:`Gelin, Birlikte Başlayalım`}),(0,j.jsx)(`p`,{className:`page-header__lead`,children:`Sağlıklı bir beslenme alışkanlığı edinmek için ilk adımı atın. Aşağıdaki kanallardan dilediğinizi seçebilirsiniz.`})]})}),(0,j.jsx)(`section`,{className:`section`,"aria-label":`İletişim formu ve bilgileri`,children:(0,j.jsxs)(`div`,{className:`container contact-layout`,children:[(0,j.jsxs)(`div`,{className:`contact-info reveal`,children:[(0,j.jsx)(`h2`,{className:`contact-info__title`,children:`Nasıl ulaşabilirsiniz?`}),(0,j.jsxs)(`div`,{className:`contact-methods`,children:[(0,j.jsxs)(`a`,{href:`https://wa.me/905542090903`,target:`_blank`,rel:`noopener noreferrer`,className:`contact-method contact-method--whatsapp`,id:`contact-whatsapp`,children:[(0,j.jsx)(`div`,{className:`contact-method__icon`,children:(0,j.jsx)(hi,{size:22})}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`strong`,{children:`WhatsApp`}),(0,j.jsx)(`span`,{children:`Hızlı yanıt için tercih edilir`})]})]}),(0,j.jsxs)(`a`,{href:`tel:+905542090903`,className:`contact-method`,id:`contact-phone`,children:[(0,j.jsx)(`div`,{className:`contact-method__icon`,children:(0,j.jsx)(_i,{size:22})}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`strong`,{children:`Telefon`}),(0,j.jsx)(`span`,{children:`+90 (554) 209 09 03`})]})]}),(0,j.jsxs)(`a`,{href:`mailto:dytezgionayli@gmail.com`,className:`contact-method`,id:`contact-email`,children:[(0,j.jsx)(`div`,{className:`contact-method__icon`,children:(0,j.jsx)(fi,{size:22})}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`strong`,{children:`E-posta`}),(0,j.jsx)(`span`,{children:`dytezgionayli@gmail.com`})]})]}),(0,j.jsxs)(`a`,{href:`https://www.instagram.com/diyetisyenezgionayli/`,target:`_blank`,rel:`noopener noreferrer`,className:`contact-method`,id:`contact-instagram`,children:[(0,j.jsx)(`div`,{className:`contact-method__icon`,children:(0,j.jsx)(ci,{size:22})}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`strong`,{children:`Instagram`}),(0,j.jsx)(`span`,{children:`@diyetisyenezgionayli`})]})]})]}),(0,j.jsxs)(`div`,{className:`clinic-info`,children:[(0,j.jsxs)(`h3`,{className:`clinic-info__title`,children:[(0,j.jsx)(pi,{size:16}),`Klinik Bilgileri`]}),(0,j.jsxs)(`p`,{className:`clinic-info__address`,children:[`Bağlarbaşı Mah. Başçılar Sok. No:1 Daire:9 (Life 226)`,(0,j.jsx)(`br`,{}),`Yalova`]}),(0,j.jsxs)(`div`,{className:`clinic-hours`,children:[(0,j.jsx)(si,{size:14}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`strong`,{children:`Çalışma Saatleri`}),(0,j.jsx)(`span`,{children:`Bilgi için iletişime geçin`})]})]})]}),(0,j.jsx)(`div`,{className:`contact-note`,children:(0,j.jsxs)(`p`,{children:[(0,j.jsx)(`strong`,{children:`Başvuru Niteliği:`}),` İletişim formu ve mesajlaşma kanalları aracılığıyla yapılan başvurular `,(0,j.jsx)(`em`,{children:`bilgi talebi`}),` niteliğindedir; randevu oluşturmaz. Değerlendirme sonrasında sizinle iletişime geçilir.`]})})]}),(0,j.jsxs)(`div`,{className:`contact-form-wrapper reveal`,children:[(0,j.jsx)(`h2`,{className:`contact-form__title`,children:`Bilgi Talep Formu`}),(0,j.jsx)(`p`,{className:`contact-form__subtitle`,children:`Formu doldurarak bilgi talebinde bulunabilirsiniz. En kısa sürede geri dönüş yapılır.`}),n?(0,j.jsxs)(`div`,{className:`form-success`,children:[(0,j.jsx)(`div`,{className:`form-success__icon`,children:`✓`}),(0,j.jsx)(`h3`,{children:`Mesajınız Alındı!`}),(0,j.jsx)(`p`,{children:`En kısa sürede sizinle iletişime geçeceğim. Teşekkürler!`})]}):(0,j.jsxs)(`form`,{onSubmit:e=>{e.preventDefault(),r(!0)},className:`contact-form`,noValidate:!0,children:[(0,j.jsxs)(`div`,{className:`grid-2`,children:[(0,j.jsxs)(`div`,{className:`form-group`,children:[(0,j.jsx)(`label`,{htmlFor:`contact-name`,className:`form-label`,children:`Ad Soyad *`}),(0,j.jsx)(`input`,{id:`contact-name`,type:`text`,className:`form-input`,placeholder:`Adınız Soyadınız`,value:e.name,onChange:n=>t({...e,name:n.target.value}),required:!0})]}),(0,j.jsxs)(`div`,{className:`form-group`,children:[(0,j.jsx)(`label`,{htmlFor:`contact-email`,className:`form-label`,children:`E-posta *`}),(0,j.jsx)(`input`,{id:`contact-email`,type:`email`,className:`form-input`,placeholder:`ornek@eposta.com`,value:e.email,onChange:n=>t({...e,email:n.target.value}),required:!0})]})]}),(0,j.jsxs)(`div`,{className:`form-group`,children:[(0,j.jsx)(`label`,{htmlFor:`contact-phone`,className:`form-label`,children:`Telefon`}),(0,j.jsx)(`input`,{id:`contact-phone`,type:`tel`,className:`form-input`,placeholder:`+90 5XX XXX XX XX`,value:e.phone,onChange:n=>t({...e,phone:n.target.value})})]}),(0,j.jsxs)(`div`,{className:`form-group`,children:[(0,j.jsx)(`label`,{htmlFor:`contact-type`,className:`form-label`,children:`Konu`}),(0,j.jsxs)(`select`,{id:`contact-type`,className:`form-select`,value:e.type,onChange:n=>t({...e,type:n.target.value}),children:[(0,j.jsx)(`option`,{value:``,children:`Konu seçin…`}),(0,j.jsx)(`option`,{value:`online`,children:`Online Danışmanlık Hakkında Bilgi`}),(0,j.jsx)(`option`,{value:`face`,children:`Yüz Yüze Danışmanlık Hakkında Bilgi`}),(0,j.jsx)(`option`,{value:`akademi`,children:`Akademi İçerikleri Hakkında`}),(0,j.jsx)(`option`,{value:`other`,children:`Diğer`})]})]}),(0,j.jsxs)(`div`,{className:`form-group`,children:[(0,j.jsx)(`label`,{htmlFor:`contact-message`,className:`form-label`,children:`Mesajınız`}),(0,j.jsx)(`textarea`,{id:`contact-message`,className:`form-textarea`,placeholder:`Soru ve beklentilerinizi kısaca paylaşın…`,value:e.message,onChange:n=>t({...e,message:n.target.value}),rows:5})]}),(0,j.jsx)(`div`,{className:`form-disclaimer`,children:(0,j.jsxs)(`p`,{children:[`* ile işaretli alanlar zorunludur. Kişisel verileriniz yalnızca iletişim amacıyla işlenir.`,` `,(0,j.jsx)(k,{to:`/kvkk`,children:`KVKK Aydınlatma Metni`}),`'ni inceleyebilirsiniz.`]})}),(0,j.jsxs)(`button`,{type:`submit`,className:`btn btn-primary btn--lg`,id:`contact-form-submit`,children:[(0,j.jsx)(yi,{size:16}),`Mesaj Gönder`]})]})]})]})}),(0,j.jsx)(`style`,{children:`
        .contact-layout {
          display: grid;
      ...
      `})]})},F=()=>(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(Ur,{children:(0,j.jsx)(`title`,{children:`KVKK Aydınlatma Metni | Diyetisyen Ezgi Onaylı Küp`})}),(0,j.jsx)(`div`,{style:{paddingTop:`calc(var(--navbar-height) + 3rem)`,paddingBottom:`4rem`},children:(0,j.jsxs)(`div`,{className:`container`,style:{maxWidth:800},children:[(0,j.jsx)(`h1`,{style:{fontFamily:`var(--font-display)`,fontSize:`var(--text-4xl)`,marginBottom:`2rem`},children:`KVKK Aydınlatma Metni`}),(0,j.jsxs)(`div`,{style:{color:`var(--color-text-mid)`,lineHeight:1.8,fontSize:`var(--text-base)`},children:[(0,j.jsxs)(`p`,{children:[`Bu aydınlatma metni, 6698 sayılı Kişisel Verilerin Korunması Kanunu ("KVKK") kapsamında `,(0,j.jsx)(`strong`,{children:`Diyetisyen Ezgi Onaylı Küp`}),` tarafından hazırlanmıştır.`]}),(0,j.jsx)(`h2`,{style:{fontFamily:`var(--font-display)`,fontSize:`var(--text-2xl)`,margin:`2rem 0 1rem`},children:`Veri Sorumlusu`}),(0,j.jsx)(`p`,{children:`Ezgi Onaylı Küp — Yalova`}),(0,j.jsx)(`h2`,{style:{fontFamily:`var(--font-display)`,fontSize:`var(--text-2xl)`,margin:`2rem 0 1rem`},children:`Hangi Veriler İşlenmektedir?`}),(0,j.jsx)(`p`,{children:`İletişim formları aracılığıyla iletilen ad-soyad, e-posta adresi, telefon numarası ve mesaj içeriği.`}),(0,j.jsx)(`h2`,{style:{fontFamily:`var(--font-display)`,fontSize:`var(--text-2xl)`,margin:`2rem 0 1rem`},children:`İşleme Amaçları`}),(0,j.jsx)(`p`,{children:`Bilgi taleplerinin yanıtlanması ve iletişim sağlanması.`}),(0,j.jsx)(`h2`,{style:{fontFamily:`var(--font-display)`,fontSize:`var(--text-2xl)`,margin:`2rem 0 1rem`},children:`Haklarınız`}),(0,j.jsx)(`p`,{children:`KVKK'nın 11. maddesi kapsamında verilerinize erişim, düzeltme, silme ve itiraz haklarınız bulunmaktadır. Talepleriniz için dytezgionayli@gmail.com adresine yazabilirsiniz.`}),(0,j.jsx)(`p`,{style:{marginTop:`2rem`,fontSize:`var(--text-sm)`,color:`var(--color-text-light)`},children:`Bu metin taslak niteliğindedir; yayına almadan önce hukuki uzman desteği alınması önerilir.`})]})]})})]});function oa(){return(0,j.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,minHeight:`60vh`,gap:`1.5rem`,textAlign:`center`,paddingTop:`var(--navbar-height)`},children:[(0,j.jsx)(`div`,{style:{fontSize:`4rem`},children:`🌿`}),(0,j.jsx)(`h1`,{style:{fontFamily:`var(--font-display)`,fontSize:`var(--text-4xl)`},children:`Sayfa Bulunamadı`}),(0,j.jsx)(`p`,{style:{color:`var(--color-text-mid)`},children:`Aradığınız sayfa mevcut değil.`}),(0,j.jsx)(`a`,{href:`/`,className:`btn btn-primary`,children:`Ana Sayfaya Dön`})]})}function sa(){return(0,j.jsx)(kr,{children:(0,j.jsx)(An,{basename:`/ezgi-onayli-kup/`,children:(0,j.jsx)(ji,{children:(0,j.jsxs)(Gt,{children:[(0,j.jsx)(Ut,{path:`/`,element:(0,j.jsx)(Bi,{})}),(0,j.jsx)(Ut,{path:`/hakkimda`,element:(0,j.jsx)(Wi,{})}),(0,j.jsx)(Ut,{path:`/danismanlik`,element:(0,j.jsx)(Ji,{})}),(0,j.jsx)(Ut,{path:`/online-danismanlik`,element:(0,j.jsx)(Zi,{})}),(0,j.jsx)(Ut,{path:`/akademi`,element:(0,j.jsx)(na,{})}),(0,j.jsx)(Ut,{path:`/beslenme-rehberi`,element:(0,j.jsx)(ra,{})}),(0,j.jsx)(Ut,{path:`/beslenme-rehberi/:slug`,element:(0,j.jsx)(ia,{})}),(0,j.jsx)(Ut,{path:`/iletisim`,element:(0,j.jsx)(aa,{})}),(0,j.jsx)(Ut,{path:`/kvkk`,element:(0,j.jsx)(F,{})}),(0,j.jsx)(Ut,{path:`/gizlilik`,element:(0,j.jsx)(F,{})}),(0,j.jsx)(Ut,{path:`/cerez`,element:(0,j.jsx)(F,{})}),(0,j.jsx)(Ut,{path:`*`,element:(0,j.jsx)(oa,{})})]})})})})}(0,v.createRoot)(document.getElementById(`root`)).render((0,j.jsx)(_.StrictMode,{children:(0,j.jsx)(sa,{})}));