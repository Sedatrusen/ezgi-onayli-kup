      ...
      <section className="hero" aria-label="Ana başlık bölümü">
        ...
        <div className="container hero__inner">
          <div className="hero__content animate-fade-up">
            <span className="badge badge-aqua hero__badge">
              <Leaf size={11} /> Yalova & Türkiye geneli
            </span>
            <h1 className="hero__title">
              Yeme davranışında<br />
              <em>beden ve zihin</em><br />
              bütünlüğü.
            </h1>
            ...
            <div className="hero__ctas">
              <Link to="/online-danismanlik" className="btn btn-primary btn--lg" id="hero-online-btn">
                Online Danışmanlık
                <ArrowRight size={18} />
              </Link>
              <Link to="/iletisim" className="btn btn-secondary btn--lg" id="hero-contact-btn">
          ...
          <div className="hero__visual animate-fade-up animate-fade-up-delay-2">
            <div className="hero__img-wrapper">
              <img
                src={heroImg}
                alt="Diyetisyen çalışma ortamı — Mediteran ilhamlı, ferah bir çalışma alanı"
                className="hero__img"
                fetchPriority="high"
              />
        ...
        {/* Decorative lemons */}
        <div className="hero__lemon" aria-hidden="true">🍋</div>
        <div className="hero__lemon hero__lemon--2" aria-hidden="true">🌿</div>
      </section>
